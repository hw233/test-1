...
CREATE TABLE `fighter` (
  ...
  `horcrux` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `player_jiguanyu` (
    ...
    `scheme` tinyint(3) unsigned NOT NULL DEFAULT '0',
    PRIMARY KEY(`playerId`, `jiguanId`, `scheme`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `friendlyCount`;
CREATE TABLE `friendlyCount` (
    `playerId` bigint(20) unsigned NOT NULL,
    `friendId` bigint(20) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `fighter_horcrux`;
