...
CREATE TABLE `fighter` (
  ...
  `trump` int(10) unsigned NOT NULL DEFAULT '0',
  `trump1` int(10) unsigned NOT NULL DEFAULT '0',
  `trump2` int(10) unsigned NOT NULL DEFAULT '0',
  `peerless` int(10) unsigned NOT NULL DEFAULT '0',
  `bloodbit` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `bloodbit1` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `bloodbit2` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `bloodbit3` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `bloodbit4` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `bloodbit5` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `bloodbit6` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `bloodbit7` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `bloodbit8` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `bloodbit9` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `bloodbit10` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `bloodbit11` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `bloodbit12` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `bloodbit13` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `bloodbit14` tinyint(3) unsigned NOT NULL DEFAULT '0',
  ...
  `citta` smallint(5) unsigned NOT NULL DEFAULT '0',
  `citta1` smallint(5) unsigned NOT NULL DEFAULT '0',
  `citta2` smallint(5) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `clan` VALUES (0,'英雄之城',40,0,0,0,'','','',0,0,39,39,0,0,0,0,0,0,0,0,1301587200,0,30,30,30,0);
