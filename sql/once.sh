...
{
    echo "update_object"
    mysql -h$H -u$U -p$P -P$PT $DBO < updates/Object_20110924_1.sql
    mysql -h$H -u$U -p$P -P$PT $DBO < updates/Object_20110930_1.sql
}

function update_data()
{
    echo "update_data"
    mysql -h$H -u$U -p$P -P$PT $DBD < updates/Data_20110928_1.sql
