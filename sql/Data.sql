...
CREATE TABLE `lingshi` (
    ...
    `attack` float(10,4) unsigned NOT NULL DEFAULT '0.00',
    `magatk` float(10,4) unsigned NOT NULL DEFAULT '0.00',
    `defend` float(10,4) unsigned NOT NULL DEFAULT '0.00',
    `magdef` float(10,4) unsigned NOT NULL DEFAULT '0.00',
    `hp` float(10,4) unsigned NOT NULL DEFAULT '0.00',
    `toughlvl` float(10,4) unsigned NOT NULL DEFAULT '0.00',
    `action` float(10,4) unsigned NOT NULL DEFAULT '0.00',
    `hitrlvl` float(10,4) unsigned NOT NULL DEFAULT '0.00',
    `evdlvl` float(10,4) unsigned NOT NULL DEFAULT '0.00',
    `crilvl` float(10,4) unsigned NOT NULL DEFAULT '0.00',
    `criticaldmg` float(10,4) unsigned NOT NULL DEFAULT '0.00',
    `pirlvl` float(10,4) unsigned NOT NULL DEFAULT '0.00',
    `counterlvl` float(10,4) unsigned NOT NULL DEFAULT '0.00',
    `mreslvl` float(10,4) unsigned NOT NULL DEFAULT '0.00',
    PRIMARY KEY (`id`, `level`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
