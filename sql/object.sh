...
function update_object()
{
    ...
    #mysql -h$H -u$U -p$P -P$PT $DBO < updates/clearbluediamond.sql  #开蓝蓝钻活动需要打开 
    #mysql -h$H -u$U -p$P -P$PT $DBO < updates/clearyellowdiamond.sql  #开蓝黄钻活动需要打开 
    #mysql -h$H -u$U -p$P -P$PT $DBO < updates/clearreddiamond.sql  #开蓝红钻活动需要打开 
    ...
    mysql -h$H -u$U -p$P -P$PT $DBO < updates/Object_20130419_1.sql
