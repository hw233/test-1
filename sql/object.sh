...
function update_object()
{
    ...
    #mysql -h$H -u$U -p$P -P$PT $DBO < updates/Object_AriBook_1121.sql     #天书奇缘清空
    #mysql -h$H -u$U -p$P -P$PT $DBO < updates/Object_clearOldMan.sql     
    #mysql -h$H -u$U -p$P -P$PT $DBO < updates/clearvar199.sql        #清除强化装备的8次限制
    ...
    mysql -h$H -u$U -p$P -P$PT $DBO < updates/Object_20140523_2.sql #一战成名每题结果
    mysql -h$H -u$U -p$P -P$PT $DBO < updates/Object_20140523_3.sql #一战成名每题支持人数
}
