solution "HoHH"
    ...
    configuration "linux"
        ...
        --defines { "_APPID=27036", "_VERSION="..os.date("%y%m%d%H%M", os.time()), "_NEED_OPENID", "_VT=1", "_VT_TEST=1"}
        defines { "_APPID=27036", "_VERSION="..os.date("%y%m%d%H%M", os.time()), "_NEED_OPENID", "_VT=1", }
