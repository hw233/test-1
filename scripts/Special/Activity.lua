...
function onNewYear(player)
    ...
    if lvl >= 30 and player:GetVar(42) == 0 then
        sendItemPackageMail(player, "新年活动-小年夜礼包", "恭喜您获得龙年12个迎新礼包，礼包在相应的日期时间可以活动双倍奖励哦！\n 1月12日-2月6日 登陆游戏，并且等级达到30的玩家可以一次性获得以下12个礼包。\n 礼包不能提前使用，必须达到对应时间后，方能使用。", {417,1,1});
        sendItemPackageMail(player, "新年活动-大年夜礼包", "恭喜您获得龙年12个迎新礼包，礼包在相应的日期时间可以活动双倍奖励哦！\n 1月12日-2月6日 登陆游戏，并且等级达到30的玩家可以一次性获得以下12个礼包。\n 礼包不能提前使用，必须达到对应时间后，方能使用。", {418,1,1});
        sendItemPackageMail(player, "新年活动-初一礼包", "恭喜您获得龙年12个迎新礼包，礼包在相应的日期时间可以活动双倍奖励哦！\n 1月12日-2月6日 登陆游戏，并且等级达到30的玩家可以一次性获得以下12个礼包。\n 礼包不能提前使用，必须达到对应时间后，方能使用。", {419,1,1});
        sendItemPackageMail(player, "新年活动-初二礼包", "恭喜您获得龙年12个迎新礼包，礼包在相应的日期时间可以活动双倍奖励哦！\n 1月12日-2月6日 登陆游戏，并且等级达到30的玩家可以一次性获得以下12个礼包。\n 礼包不能提前使用，必须达到对应时间后，方能使用。", {420,1,1});
        sendItemPackageMail(player, "新年活动-初三礼包", "恭喜您获得龙年12个迎新礼包，礼包在相应的日期时间可以活动双倍奖励哦！\n 1月12日-2月6日 登陆游戏，并且等级达到30的玩家可以一次性获得以下12个礼包。\n 礼包不能提前使用，必须达到对应时间后，方能使用。", {421,1,1});
        sendItemPackageMail(player, "新年活动-初四礼包", "恭喜您获得龙年12个迎新礼包，礼包在相应的日期时间可以活动双倍奖励哦！\n 1月12日-2月6日 登陆游戏，并且等级达到30的玩家可以一次性获得以下12个礼包。\n 礼包不能提前使用，必须达到对应时间后，方能使用。", {422,1,1});
        sendItemPackageMail(player, "新年活动-初五礼包", "恭喜您获得龙年12个迎新礼包，礼包在相应的日期时间可以活动双倍奖励哦！\n 1月12日-2月6日 登陆游戏，并且等级达到30的玩家可以一次性获得以下12个礼包。\n 礼包不能提前使用，必须达到对应时间后，方能使用。", {423,1,1});
        sendItemPackageMail(player, "新年活动-初六礼包", "恭喜您获得龙年12个迎新礼包，礼包在相应的日期时间可以活动双倍奖励哦！\n 1月12日-2月6日 登陆游戏，并且等级达到30的玩家可以一次性获得以下12个礼包。\n 礼包不能提前使用，必须达到对应时间后，方能使用。", {424,1,1});
        sendItemPackageMail(player, "新年活动-初七礼包", "恭喜您获得龙年12个迎新礼包，礼包在相应的日期时间可以活动双倍奖励哦！\n 1月12日-2月6日 登陆游戏，并且等级达到30的玩家可以一次性获得以下12个礼包。\n 礼包不能提前使用，必须达到对应时间后，方能使用。", {425,1,1});
        sendItemPackageMail(player, "新年活动-初八礼包", "恭喜您获得龙年12个迎新礼包，礼包在相应的日期时间可以活动双倍奖励哦！\n 1月12日-2月6日 登陆游戏，并且等级达到30的玩家可以一次性获得以下12个礼包。\n 礼包不能提前使用，必须达到对应时间后，方能使用。", {426,1,1});
        sendItemPackageMail(player, "新年活动-立春礼包", "恭喜您获得龙年12个迎新礼包，礼包在相应的日期时间可以活动双倍奖励哦！\n 1月12日-2月6日 登陆游戏，并且等级达到30的玩家可以一次性获得以下12个礼包。\n 礼包不能提前使用，必须达到对应时间后，方能使用。", {427,1,1});
        sendItemPackageMail(player, "新年活动-元宵礼包", "恭喜您获得龙年12个迎新礼包，礼包在相应的日期时间可以活动双倍奖励哦！\n 1月12日-2月6日 登陆游戏，并且等级达到30的玩家可以一次性获得以下12个礼包。\n 礼包不能提前使用，必须达到对应时间后，方能使用。", {428,1,1});
