...
os.execute("cat log/DB/TRACE20140622 |grep var |grep [^0-9]599[^0-9] > test1.txt")  --需要修改cat语句已限制时间段
os.execute("awk '{print $11,$13,$14}' test1.txt > test2.txt ")  --产生文件的格式为(XXXX, XXXX, XXXX)]
...
for i in file:lines() do 
    ...
    str2 = string.sub(i,first+2,second - 1) --获取玩家数值
