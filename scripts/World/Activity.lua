...
function onActivityCheck(tm)
  ...
  if isFBVersion() then
      ...
      elseif tm >= actTime2013_04_09 and tm < actTime2013_04_09+5*86400 then
          setRechargeActive(true, 16)
          setNeedRechargeRank(true)
      elseif tm >= actTime2013_04_14 and tm < actTime2013_04_14+314*86400 then
          -- RECHARGE
          setRechargeActive(true, 16)
          setNeedRechargeRank(true)
      else
  ...
  -- ACC
  if tm >= actTime2014_01_25 and tm < (actTime2014_01_25 + 29*86400) then
      setAccRecharge(true)
  else
...
function initActTime(y, m, d)
  ...
  -- 3366合作礼包
  local  SerStartTm536= { ['year'] = 2014, ['month'] = 1, ['day'] = 10, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  -- Qzong,pengyou合作礼包
...
--愚公宝箱
  ...
  --特殊古籍活动
  local  SerStartTm242 = { ['year'] = 2014, ['month'] = 2, ['day'] = 14, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  local  SerStartTm242_1 = { ['year'] = 2014, ['month'] = 2, ['day'] = 17, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  --大厅累积在线奖励
...
--暑假回流
  ...
  local  SerStartTm253= { ['year'] = 2014, ['month'] = 2, ['day'] = 24, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  local  SerStartTm253_1= { ['year'] = 2014, ['month'] = 3, ['day'] = 1, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
