...
function onActivityCheck(tm)
  ...
  if isFBVersion() then
      ...
      elseif tm >= actTime2013_04_09 and tm < actTime2013_04_09+5*86400 then
          setRechargeActive(true, 16)
          setNeedRechargeRank(true)
      elseif tm >= actTime2013_04_14 and tm < actTime2013_04_14+195*86400 then
          setRechargeActive(true, 16)
          setNeedRechargeRank(true)
      else
          setRechargeActive(false, 16)
  ...
  if tm >= actTime2013_05_18 and tm < (actTime2013_05_18 + 161*86400) then
      setAccRecharge(true)
  else
...
function initActTime(y, m, d)
  ...
  local  SerStartTm14= { ['year'] = 2013, ['month'] = 11, ['day'] = 2, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  -- 清明节
...
--愚公宝箱
  ...
  local  SerStartTm555_1= { ['year'] = 2013, ['month'] = 4, ['day'] = 15, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
    ...
    --蜀山传奇掉落活动
  local  SerStartTm556= { ['year'] = 2013, ['month'] = 7, ['day'] = 13, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  local  SerStartTm556_1= { ['year'] = 2013, ['month'] = 7, ['day'] = 15, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  ...
  --节日套装-五道杠
  local  SerStartTm232 = { ['year'] = 2013, ['month'] = 9, ['day'] = 19, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  -- 锦云兜商城
  ...
  --特殊古籍活动
  local  SerStartTm242 = { ['year'] = 2013, ['month'] = 10, ['day'] = 19, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  local  SerStartTm242_1 = { ['year'] = 2013, ['month'] = 10, ['day'] = 22, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  --大厅累积在线奖励
  ...
  --落英秘典
  local  SerStartTm246 = { ['year'] = 2013, ['month'] = 10, ['day'] = 26, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  --消费抽奖活动
...
--暑假回流
  ...
  actTime232_1= os.time(SerStartTm232) + 4 * 86400;
