...
function onActivityCheck(tm)
  ...
  if isFBVersion() then
      ...
      if tm >= actTime2013_04_14 and tm < actTime2013_04_14+573*86400 then
          -- RECHARGE
          setRechargeActive(true, 16)
          setNeedRechargeRank(true)
      else
  ...
  if tm >= actTime2014_01_25 and tm < (actTime2014_01_25 + 267*86400) then
      setAccRecharge(1)
  elseif tm >= actTime2014_10_18 and tm < (actTime2014_10_18 + 21*86400) then
      setAccRecharge(2)
  else
      setAccRecharge(0)
  end
...
--愚公宝箱
  ...
  -- 迎新纳福 红包入袋
  local  SerStartTm237 = { ['year'] = 2014, ['month'] = 9, ['day'] = 30, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  -- 蓝钻新年回馈活动
  ...
  --特殊古籍活动
  local  SerStartTm242 = { ['year'] = 2014, ['month'] = 9, ['day'] = 27, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  local  SerStartTm242_1 = { ['year'] = 2014, ['month'] = 9, ['day'] = 29, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  --大厅累积在线奖励
...
--暑假回流
  ...
  local  SerStartTm257= { ['year'] = 2014, ['month'] = 9, ['day'] = 29, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  local  SerStartTm257_1= { ['year'] = 2014, ['month'] = 10, ['day'] = 9, ['hour'] = 0, ['min'] = 0, ['sec'] = 0 };
  ...
  actTime237_1= os.time(SerStartTm237) + 8 * 86400;
