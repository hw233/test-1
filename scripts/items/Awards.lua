...
function RunBlueDiamondAward(player, opt)
    ...
    local chance = {
        [1] = {1050, 2265, 3480, 4700, 6620, 8540, 9270, 10000},
    ...
    local item = {
        [1] = {{515,3},{9338,4},{134,4},{1325,4},{507,2},{509,2},{1717,1},{5036,1}},
    ...
    local extraAward_9191_blue = {
        [2] = {9190,1,1},
        [6] = {50,2,1, 9371,5,1, 548,10,1},
        [12] = {509,5,1, 507,5,1, 1707,1,1},
        [20]= {9076,5,1, 515,5,1, 1717,1,1},
    };
...
function onGetQZoneQQGameAward(player, type)
    ...
    local awards = {
        ...
        [1] = {{51, 1},{1327, 1},{56, 1},{57, 1}, {9390, 3}, {9367, 5}},
        [2] = {{49, 1},{1326, 1},{56, 1},{57, 1}, {9390, 6}, {9369, 5}}
    }
