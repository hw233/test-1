...
function RunBlueDiamondAward(player, opt)
    ...
    local chance = {
        [1] = {1050, 2265, 3480, 4695, 6220, 7745, 9270, 10000},
    ...
    local item = {
        [1] = {{515,3},{9338,4},{134,4},{1325,4},{507,2},{509,2},{47,3},{5006,1}},
...
local LevelAwards = {
    ...
    [55] = {{9371, 5},{52, 2},{503, 5},{514, 5}},
    [56] = {{9371, 5},{52, 2},{500, 5},{515, 3}},
    [57] = {{9371, 5},{52, 2},{500, 5},{515, 3}},
    [58] = {{9371, 5},{52, 2},{500, 5},{515, 3}},
    [59] = {{9371, 5},{52, 2},{500, 5},{515, 3}},

    [60] = {{33, 3},{500, 5},{505, 5},{511, 5}},
    [61] = {{33, 3},{500, 5},{505, 5},{511, 5}},
    [62] = {{33, 5},{500, 5},{505, 5},{511, 5}},
    [63] = {{33, 5},{500, 5},{505, 5},{511, 5}},
    [64] = {{33, 8},{500, 5},{52, 3},{15, 5}},
    [65] = {{33, 8},{500, 5},{52, 3},{15, 5}},
    [66] = {{33, 10},{500, 5},{52, 3},{15, 5}},
    [67] = {{33, 10},{500, 5},{52, 3},{15, 5}},
    ...
    [103] = {{9035 ,8},{9338, 8},{500, 15},{53,5}},
    [104] = {{9035 ,8},{134, 8},{500, 15},{53,5}},
    [105] = {{9371 ,8},{134, 8},{500, 15},{53,5}},
    [106] = {{9371 ,8},{134, 8},{500, 15},{53,5}},
    [107] = {{9371 ,8},{1325, 8},{500, 15},{53,5}},
    ...
    [117] = {{503 ,8},{134, 8},{8000, 8},{53,5}},
    [118] = {{503 ,8},{1325, 8},{8000, 8},{53,5}},
    [119] = {{503 ,8},{9338, 8},{8000, 8},{53,5}},
    [120] = {{515 ,8},{134, 8},{8000, 8},{53,5}},
    [121] = {{515 ,8},{1325, 8},{8000, 8},{53,5}},
    [122] = {{515 ,8},{9338, 8},{8000, 8},{53,5}},
    [123] = {{503 ,8},{134, 8},{8000, 8},{53,5}},
    [124] = {{503 ,8},{1325, 8},{8000, 8},{53,5}},
    [125] = {{503 ,8},{9338, 8},{8000, 8},{53,5}},
    [126] = {{515 ,8},{134, 8},{8000, 8},{53,5}},
    [127] = {{515 ,8},{1325, 8},{8000, 8},{53,5}},
    [128] = {{515 ,8},{9338, 8},{8000, 8},{53,5}},
    [129] = {{503 ,8},{134, 8},{8000, 8},{53,5}},
    [130] = {{503 ,8},{1325, 8},{8000, 8},{53,5}},
    [131] = {{503 ,8},{9338, 8},{8000, 8},{53,5}},
    [132] = {{515 ,8},{134, 8},{8000, 8},{53,5}},
    [133] = {{515 ,8},{1325, 8},{8000, 8},{53,5}},
    [134] = {{515 ,8},{9338, 8},{8000, 8},{53,5}},
    [135] = {{503 ,8},{134, 8},{8000, 8},{53,5}},
    [136] = {{503 ,8},{1325, 8},{8000, 8},{53,5}},
    [137] = {{503 ,8},{9338, 8},{8000, 8},{53,5}},
    [138] = {{515 ,8},{134, 8},{8000, 8},{53,5}},
