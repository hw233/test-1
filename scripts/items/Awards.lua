...
function RunBlueDiamondAward(player, opt)
    ...
    local item = {
        ...
        [7] = {{503,1},{500,1},{517,1},{515,1},{9178,1},{1325,1},{516,1},{8555,1},{134,1},{137,1},{56,2},{8521,1}}
    };
    ...
    if opt ==7 and (items[j][1] == 134 or items[j][1]==515 or items[j][1] == 1325 or items[j][1]==8521 or items[j][1] == 8555 or items[j][1] == 9178 or items[j][1] ==137)  then 
        Broadcast(0x27, "[p:"..player:getCountry()..":"..player:getPName().."]".."通过财富罗盘获得了".."[4:"..items[j][1].."]x1")
   end
