...
function Task_00000119(npcId)
	...
	if task:GetTaskAcceptNpc(119) == npcId and Task_Accept_00000119 () then
		...
		action.m_ActionMsg = task_msg_000560;
	elseif task:GetTaskSubmitNpc(119) == npcId then
		if Task_Submit_00000119() then
			...
			action.m_ActionMsg = task_msg_000561;
		elseif task:HasAcceptedTask(119) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 119
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_000562;
		end
	end
	return action;
end
...
function Task_00000119_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000563..GetPlayerName(GetPlayer())..task_msg_000564;
	action.m_ActionMsg = task_msg_000565;
	return action;
end
...
function Task_00000119_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000566;
	action.m_ActionMsg = "";
	return action;
end
