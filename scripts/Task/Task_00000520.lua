...
function Task_00000520(npcId)
	...
	if task:GetTaskAcceptNpc(520) == npcId and Task_Accept_00000520 () then
		...
		action.m_ActionMsg = task_msg_000755;
...
function Task_00000520_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000758;
	action.m_ActionMsg = task_msg_000759;
	return action;
end
...
function Task_00000520_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_000760;
	action.m_ActionMsg = "";
	return action;
end
