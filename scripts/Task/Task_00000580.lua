...
function Task_00000580_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001494..GetPlayerName(GetPlayer())..task_msg_001495;
	action.m_ActionMsg = task_msg_001496;
	return action;
end
...
function Task_00000580_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001497;
	action.m_ActionMsg = "";
	return action;
end
