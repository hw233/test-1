...
function Task_00000076(npcId)
	...
	if task:GetTaskAcceptNpc(76) == npcId and Task_Accept_00000076 () then
		...
		action.m_ActionMsg = task_msg_004513;
	elseif task:GetTaskSubmitNpc(76) == npcId then
		if Task_Submit_00000076() then
			...
			action.m_ActionMsg = task_msg_004514;
		elseif task:HasAcceptedTask(76) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 76
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_004515;
		end
	end
	return action;
end
...
function Task_00000076_step_01()
	...
	action.m_NpcMsg = task_msg_004516;
	action.m_ActionMsg = task_msg_004517;
	return action;
end
...
function Task_00000076_step_02()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004518;
	action.m_ActionMsg = task_msg_004519;
	return action;
end
...
function Task_00000076_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004520;
	action.m_ActionMsg = "";
	return action;
end
