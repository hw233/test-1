...
function Task_00000076(npcId)
	...
	if task:GetTaskAcceptNpc(76) == npcId and Task_Accept_00000076 () then
		...
		action.m_ActionMsg = task_msg_1993;
...
function Task_00000076_step_01()
	...
	action.m_NpcMsg = task_msg_1996;
	action.m_ActionMsg = task_msg_1997;
	return action;
end
...
function Task_00000076_step_02()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_1998;
	action.m_ActionMsg = task_msg_1999;
	return action;
end
