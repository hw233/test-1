...
function Task_00000573(npcId)
	...
	if task:GetTaskAcceptNpc(573) == npcId and Task_Accept_00000573 () then
		...
		action.m_ActionMsg = task_msg_003586;
	elseif task:GetTaskSubmitNpc(573) == npcId then
		if Task_Submit_00000573() then
			...
			action.m_ActionMsg = task_msg_003587;
		elseif task:HasAcceptedTask(573) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 573
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003588;
		end
	end
	return action;
end
...
function Task_00000573_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003589..GetPlayerName(GetPlayer())..task_msg_003590;
	action.m_ActionMsg = task_msg_003591;
	return action;
end
...
function Task_00000573_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_003592;
	action.m_ActionMsg = "";
	return action;
end
