...
function Task_00000573(npcId)
	...
	if task:GetTaskAcceptNpc(573) == npcId and Task_Accept_00000573 () then
		...
		action.m_ActionMsg = task_msg_001079;
	elseif task:GetTaskSubmitNpc(573) == npcId then
		...
		elseif task:HasAcceptedTask(573) then
			...
			action.m_ActionMsg = task_msg_001081;
		end
	end
	return action;
end
...
function Task_00000573_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001082..GetPlayerName(GetPlayer())..task_msg_001083;
	action.m_ActionMsg = task_msg_001084;
	return action;
end
...
function Task_00000573_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001085;
	action.m_ActionMsg = "";
	return action;
end
