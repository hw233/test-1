...
function Task_00000573(npcId)
	...
	elseif task:GetTaskSubmitNpc(573) == npcId then
		...
		elseif task:HasAcceptedTask(573) then
			...
			action.m_ActionMsg = task_msg_1185;
		end
	end
	return action;
end
...
function Task_00000573_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_1186..GetPlayerName(GetPlayer())..task_msg_1187;
	action.m_ActionMsg = task_msg_1188;
	return action;
end
...
function Task_00000573_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_1189;
	action.m_ActionMsg = "";
	return action;
end
