...
function Task_00000105_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = "æˆéƒ½å‰æ®µæ—¶é—´æ²»å®‰çœŸå¾—å¾ˆæˆé—®é¢˜ï¼Œæœ‰å‡ ä¸ªå¤§æˆ·äººå®¶çš„å°å§éƒ½è¢«é‚£é‡‡èŠ±å¤§ç›—ç³Ÿè¹‹ï¼Œè¿˜å¸Œæœ›<name>å»å°†è¿™ä¸ªæ·«è´¼æ‰æ‹¿å½’æ¡ˆã€‚";
...
function Task_00000105_submit(itemId, itemNum)
	...
	if task:CanDayTaskSubmit(105) then
		if DayTaskAward(0) then
			task:DayTaskSubmit(105);
			return true;
		end
	end
