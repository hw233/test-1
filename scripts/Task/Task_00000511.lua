...
function Task_00000511(npcId)
	...
	if task:GetTaskAcceptNpc(511) == npcId and Task_Accept_00000511 () then
		...
		action.m_ActionMsg = task_msg_003174;
	elseif task:GetTaskSubmitNpc(511) == npcId then
		if Task_Submit_00000511() then
			...
			action.m_ActionMsg = task_msg_003175;
		elseif task:HasAcceptedTask(511) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 511
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003176;
		end
	end
	return action;
end
...
function Task_00000511_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003177..GetPlayerName(GetPlayer())..task_msg_003178;
	action.m_ActionMsg = task_msg_003179;
	return action;
end
...
function Task_00000511_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003180;
	action.m_ActionMsg = "";
	return action;
end
