...
function Task_00000640(npcId)
	...
	if task:GetTaskAcceptNpc(640) == npcId and Task_Accept_00000640 () then
		...
		action.m_ActionMsg = task_msg_001258;
	elseif task:GetTaskSubmitNpc(640) == npcId then
		if Task_Submit_00000640() then
			...
			action.m_ActionMsg = task_msg_001259;
...
function Task_00000640_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001261..GetPlayerName(GetPlayer())..task_msg_001262;
	action.m_ActionMsg = task_msg_001263;
	return action;
end
...
function Task_00000640_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001264;
	action.m_ActionMsg = "";
	return action;
end
