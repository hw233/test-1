...
function Task_00000612(npcId)
	...
	elseif task:GetTaskSubmitNpc(612) == npcId then
		if Task_Submit_00000612() then
			...
			action.m_ActionMsg = task_msg_000937;
		elseif task:HasAcceptedTask(612) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 612
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_000938;
		end
	end
	return action;
end
...
function Task_00000612_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000939;
	action.m_ActionMsg = task_msg_000940;
	return action;
end
...
function Task_00000612_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000941;
	action.m_ActionMsg = "";
	return action;
end
