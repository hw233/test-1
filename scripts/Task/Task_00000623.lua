...
function Task_00000623(npcId)
	...
	elseif task:GetTaskSubmitNpc(623) == npcId then
		if Task_Submit_00000623() then
			...
			action.m_ActionMsg = task_msg_1251;
...
function Task_00000623_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_1253..GetPlayerName(GetPlayer())..task_msg_1254;
	action.m_ActionMsg = task_msg_1255;
	return action;
end
...
function Task_00000623_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_1256;
	action.m_ActionMsg = "";
	return action;
end
