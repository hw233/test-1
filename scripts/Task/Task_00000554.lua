...
function Task_00000554(npcId)
	...
	if task:GetTaskAcceptNpc(554) == npcId and Task_Accept_00000554 () then
		...
		action.m_ActionMsg = task_msg_000788;
	elseif task:GetTaskSubmitNpc(554) == npcId then
		if Task_Submit_00000554() then
			...
			action.m_ActionMsg = task_msg_000789;
		elseif task:HasAcceptedTask(554) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 554
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_000790;
		end
	end
	return action;
end
...
function Task_00000554_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000791..GetPlayerName(GetPlayer())..task_msg_000792;
...
function Task_00000554_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_000794;
	action.m_ActionMsg = "";
	return action;
end
