...
function Task_00000525(npcId)
	...
	if task:GetTaskAcceptNpc(525) == npcId and Task_Accept_00000525 () then
		...
		action.m_ActionMsg = task_msg_1053;
...
function Task_00000525_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_1056..GetPlayerName(GetPlayer())..task_msg_1057;
...
function Task_00000525_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_1059;
	action.m_ActionMsg = "";
	return action;
end
