...
function Task_00000525(npcId)
	...
	if task:GetTaskAcceptNpc(525) == npcId and Task_Accept_00000525 () then
		...
		action.m_ActionMsg = task_msg_001059;
	elseif task:GetTaskSubmitNpc(525) == npcId then
		if Task_Submit_00000525() then
			...
			action.m_ActionMsg = task_msg_001060;
		elseif task:HasAcceptedTask(525) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 525
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_001061;
		end
	end
	return action;
end
...
function Task_00000525_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001062..GetPlayerName(GetPlayer())..task_msg_001063;
...
function Task_00000525_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001065;
	action.m_ActionMsg = "";
	return action;
end
