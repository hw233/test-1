...
function Task_00000616(npcId)
	...
	elseif task:GetTaskSubmitNpc(616) == npcId then
		...
		elseif task:HasAcceptedTask(616) then
			...
			action.m_ActionMsg = task_msg_001102;
		end
	end
	return action;
end
...
function Task_00000616_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001103..GetPlayerName(GetPlayer())..task_msg_001104;
...
function Task_00000616_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001106;
	action.m_ActionMsg = "";
	return action;
end
