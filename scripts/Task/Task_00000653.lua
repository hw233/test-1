...
function Task_00000653(npcId)
	...
	if task:GetTaskAcceptNpc(653) == npcId and Task_Accept_00000653 () then
		...
		action.m_ActionMsg = task_msg_004387;
	elseif task:GetTaskSubmitNpc(653) == npcId then
		if Task_Submit_00000653() then
			...
			action.m_ActionMsg = task_msg_004388;
		elseif task:HasAcceptedTask(653) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 653
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_004389;
		end
	end
	return action;
end
...
function Task_00000653_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004390..GetPlayerName(GetPlayer())..task_msg_004391;
	action.m_ActionMsg = task_msg_004392;
	return action;
end
...
function Task_00000653_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_004393;
	action.m_ActionMsg = "";
	return action;
end
