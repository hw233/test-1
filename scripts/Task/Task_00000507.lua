...
function Task_00000507(npcId)
	...
	if task:GetTaskAcceptNpc(507) == npcId and Task_Accept_00000507 () then
		...
		action.m_ActionMsg = task_msg_003146;
	elseif task:GetTaskSubmitNpc(507) == npcId then
		if Task_Submit_00000507() then
			...
			action.m_ActionMsg = task_msg_003147;
		elseif task:HasAcceptedTask(507) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 507
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003148;
		end
	end
	return action;
end
...
function Task_00000507_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003149..GetPlayerName(GetPlayer())..task_msg_003150;
	action.m_ActionMsg = task_msg_003151;
	return action;
end
...
function Task_00000507_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_003152;
	action.m_ActionMsg = "";
	return action;
end
