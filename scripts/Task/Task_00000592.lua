...
function Task_00000592(npcId)
	...
	if task:GetTaskAcceptNpc(592) == npcId and Task_Accept_00000592 () then
		...
		action.m_ActionMsg = task_msg_004007;
	elseif task:GetTaskSubmitNpc(592) == npcId then
		if Task_Submit_00000592() then
			...
			action.m_ActionMsg = task_msg_004008;
		elseif task:HasAcceptedTask(592) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 592
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_004009;
		end
	end
	return action;
end
...
function Task_00000592_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004010;
	action.m_ActionMsg = task_msg_004011;
	return action;
end
...
function Task_00000592_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_004012;
	action.m_ActionMsg = "";
	return action;
end
