...
function Task_00000140(npcId)
	...
	if task:GetTaskAcceptNpc(140) == npcId and Task_Accept_00000140 () then
		...
		action.m_ActionMsg = task_msg_001643;
...
function Task_00000140_step_01()
	...
	action.m_NpcMsg = task_msg_001646;
	action.m_ActionMsg = task_msg_001647;
	return action;
end
...
function Task_00000140_step_02()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001648;
	action.m_ActionMsg = task_msg_001649;
	return action;
end
...
function Task_00000140_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001650;
	action.m_ActionMsg = "";
	return action;
end
