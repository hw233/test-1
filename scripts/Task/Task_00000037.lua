...
function Task_00000037(npcId)
	...
	if task:GetTaskAcceptNpc(37) == npcId and Task_Accept_00000037 () then
		...
		action.m_ActionMsg = task_msg_000967;
...
function Task_00000037_step_01()
	...
	action.m_NpcMsg = task_msg_000970..GetPlayerName(GetPlayer())..task_msg_000971;
...
function Task_00000037_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_000975;
	action.m_ActionMsg = "";
	return action;
end
