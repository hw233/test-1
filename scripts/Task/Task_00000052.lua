...
function Task_00000052(npcId)
	...
	elseif task:GetTaskSubmitNpc(52) == npcId then
		if Task_Submit_00000052() then
			...
			action.m_ActionMsg = task_msg_001002;
		elseif task:HasAcceptedTask(52) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 52
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_001003;
		end
	end
	return action;
end
...
function Task_00000052_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001004;
	action.m_ActionMsg = task_msg_001005;
	return action;
end
...
function Task_00000052_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001006;
	action.m_ActionMsg = "";
	return action;
end
