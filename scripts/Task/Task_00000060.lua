...
function Task_00000060(npcId)
	...
	if task:GetTaskAcceptNpc(60) == npcId and Task_Accept_00000060 () then
		...
		action.m_ActionMsg = task_msg_1571;
...
function Task_00000060_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_1574..GetPlayerName(GetPlayer())..task_msg_1575;
...
function Task_00000060_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_1577;
	action.m_ActionMsg = "";
	return action;
end
