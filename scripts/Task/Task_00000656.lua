...
function Task_00000656(npcId)
	...
	if task:GetTaskAcceptNpc(656) == npcId and Task_Accept_00000656 () then
		...
		action.m_ActionMsg = task_msg_004408;
	elseif task:GetTaskSubmitNpc(656) == npcId then
		if Task_Submit_00000656() then
			...
			action.m_ActionMsg = task_msg_004409;
		elseif task:HasAcceptedTask(656) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 656
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_004410;
		end
	end
	return action;
end
...
function Task_00000656_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004411..GetPlayerName(GetPlayer())..task_msg_004412;
	action.m_ActionMsg = task_msg_004413;
	return action;
end
...
function Task_00000656_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_004414;
	action.m_ActionMsg = "";
	return action;
end
