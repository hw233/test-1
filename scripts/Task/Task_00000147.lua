...
function Task_00000147(npcId)
	...
	elseif task:GetTaskSubmitNpc(147) == npcId then
		...
		elseif task:HasAcceptedTask(147) then
			...
			action.m_ActionMsg = task_msg_001754;
		end
	end
	return action;
end
...
function Task_00000147_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001755;
	action.m_ActionMsg = task_msg_001756;
	return action;
end
...
function Task_00000147_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001757;
	action.m_ActionMsg = "";
	return action;
end
