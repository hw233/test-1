...
function Task_00000147(npcId)
	...
	if task:GetTaskAcceptNpc(147) == npcId and Task_Accept_00000147 () then
		...
		action.m_ActionMsg = task_msg_004259;
	elseif task:GetTaskSubmitNpc(147) == npcId then
		if Task_Submit_00000147() then
			...
			action.m_ActionMsg = task_msg_004260;
		elseif task:HasAcceptedTask(147) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 147
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_004261;
		end
	end
	return action;
end
...
function Task_00000147_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004262;
	action.m_ActionMsg = task_msg_004263;
	return action;
end
...
function Task_00000147_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_004264;
	action.m_ActionMsg = "";
	return action;
end
