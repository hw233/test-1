...
function Task_00000523(npcId)
	...
	if task:GetTaskAcceptNpc(523) == npcId and Task_Accept_00000523 () then
		...
		action.m_ActionMsg = task_msg_001038;
...
function Task_00000523_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001041..GetPlayerName(GetPlayer())..task_msg_001042;
...
function Task_00000523_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001044;
	action.m_ActionMsg = "";
	return action;
end
