...
function Task_00000532(npcId)
	...
	if task:GetTaskAcceptNpc(532) == npcId and Task_Accept_00000532 () then
		...
		action.m_ActionMsg = task_msg_1410;
...
function Task_00000532_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_1413..GetPlayerName(GetPlayer())..task_msg_1414;
	action.m_ActionMsg = task_msg_1415;
	return action;
end
...
function Task_00000532_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_1416;
	action.m_ActionMsg = "";
	return action;
end
