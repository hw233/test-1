...
function Task_00000153(npcId)
	...
	if task:GetTaskAcceptNpc(153) == npcId and Task_Accept_00000153 () then
		...
		action.m_ActionMsg = task_msg_001650;
...
function Task_00000153_step_01()
	...
	action.m_NpcMsg = task_msg_001653;
	action.m_ActionMsg = task_msg_001654;
	return action;
end
...
function Task_00000153_step_02()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001655;
	action.m_ActionMsg = task_msg_001656;
	return action;
end
...
function Task_00000153_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001657;
	action.m_ActionMsg = "";
	return action;
end
