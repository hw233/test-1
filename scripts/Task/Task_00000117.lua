...
function Task_00000117(npcId)
	...
	elseif task:GetTaskSubmitNpc(117) == npcId then
		if Task_Submit_00000117() then
			...
			action.m_ActionMsg = task_msg_000575;
		elseif task:HasAcceptedTask(117) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 117
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_000576;
		end
	end
	return action;
end
...
function Task_00000117_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000577;
	action.m_ActionMsg = task_msg_000578;
	return action;
end
...
function Task_00000117_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000579;
	action.m_ActionMsg = "";
	return action;
end
