...
function Task_00000590(npcId)
	...
	if task:GetTaskAcceptNpc(590) == npcId and Task_Accept_00000590 () then
		...
		action.m_ActionMsg = task_msg_001554;
	elseif task:GetTaskSubmitNpc(590) == npcId then
		if Task_Submit_00000590() then
			...
			action.m_ActionMsg = task_msg_001555;
		elseif task:HasAcceptedTask(590) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 590
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_001556;
		end
	end
	return action;
end
...
function Task_00000590_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001557;
	action.m_ActionMsg = task_msg_001558;
	return action;
end
...
function Task_00000590_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001559;
	action.m_ActionMsg = "";
	return action;
end
