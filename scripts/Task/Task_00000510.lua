...
function Task_00000510(npcId)
	...
	if task:GetTaskAcceptNpc(510) == npcId and Task_Accept_00000510 () then
		...
		action.m_ActionMsg = task_msg_000660;
	elseif task:GetTaskSubmitNpc(510) == npcId then
		if Task_Submit_00000510() then
			...
			action.m_ActionMsg = task_msg_000661;
...
function Task_00000510_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000663..GetPlayerName(GetPlayer())..task_msg_000664;
	action.m_ActionMsg = task_msg_000665;
	return action;
end
...
function Task_00000510_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_000666;
	action.m_ActionMsg = "";
	return action;
end
