...
function Task_00000510(npcId)
	...
	if task:GetTaskAcceptNpc(510) == npcId and Task_Accept_00000510 () then
		...
		action.m_ActionMsg = task_msg_003167;
	elseif task:GetTaskSubmitNpc(510) == npcId then
		if Task_Submit_00000510() then
			...
			action.m_ActionMsg = task_msg_003168;
		elseif task:HasAcceptedTask(510) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 510
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003169;
		end
	end
	return action;
end
...
function Task_00000510_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003170..GetPlayerName(GetPlayer())..task_msg_003171;
	action.m_ActionMsg = task_msg_003172;
	return action;
end
...
function Task_00000510_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_003173;
	action.m_ActionMsg = "";
	return action;
end
