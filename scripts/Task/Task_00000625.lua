...
function Task_00000625(npcId)
	...
	if task:GetTaskAcceptNpc(625) == npcId and Task_Accept_00000625 () then
		...
		action.m_ActionMsg = task_msg_1264;
...
function Task_00000625_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_1267..GetPlayerName(GetPlayer())..task_msg_1268;
	action.m_ActionMsg = task_msg_1269;
	return action;
end
...
function Task_00000625_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_1270;
	action.m_ActionMsg = "";
	return action;
end
