...
function Task_00000601(npcId)
	...
	elseif task:GetTaskSubmitNpc(601) == npcId then
		if Task_Submit_00000601() then
			...
			action.m_ActionMsg = task_msg_001020;
...
function Task_00000601_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001022;
	action.m_ActionMsg = task_msg_001023;
	return action;
end
...
function Task_00000601_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001024;
	action.m_ActionMsg = "";
	return action;
end
