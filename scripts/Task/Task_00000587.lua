...
function Task_00000587(npcId)
	...
	elseif task:GetTaskSubmitNpc(587) == npcId then
		if Task_Submit_00000587() then
			...
			action.m_ActionMsg = task_msg_001469;
		elseif task:HasAcceptedTask(587) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 587
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_001470;
		end
	end
	return action;
end
...
function Task_00000587_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001471;
	action.m_ActionMsg = task_msg_001472;
	return action;
end
...
function Task_00000587_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001473;
	action.m_ActionMsg = "";
	return action;
end
