...
function Task_00000568(npcId)
	...
	if task:GetTaskAcceptNpc(568) == npcId and Task_Accept_00000568 () then
		...
		action.m_ActionMsg = task_msg_000880;
...
function Task_00000568_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000883..GetPlayerName(GetPlayer())..task_msg_000884;
	action.m_ActionMsg = task_msg_000885;
	return action;
end
...
function Task_00000568_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000886;
	action.m_ActionMsg = "";
	return action;
end
