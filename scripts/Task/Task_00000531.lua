...
function Task_00000531(npcId)
	...
	if task:GetTaskAcceptNpc(531) == npcId and Task_Accept_00000531 () then
		...
		action.m_ActionMsg = task_msg_003806;
	elseif task:GetTaskSubmitNpc(531) == npcId then
		if Task_Submit_00000531() then
			...
			action.m_ActionMsg = task_msg_003807;
		elseif task:HasAcceptedTask(531) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 531
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003808;
		end
	end
	return action;
end
...
function Task_00000531_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003809..GetPlayerName(GetPlayer())..task_msg_003810;
	action.m_ActionMsg = task_msg_003811;
	return action;
end
...
function Task_00000531_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003812;
	action.m_ActionMsg = "";
	return action;
end
