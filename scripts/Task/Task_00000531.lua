...
function Task_00000531(npcId)
	...
	if task:GetTaskAcceptNpc(531) == npcId and Task_Accept_00000531 () then
		...
		action.m_ActionMsg = task_msg_1403;
...
function Task_00000531_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_1406..GetPlayerName(GetPlayer())..task_msg_1407;
	action.m_ActionMsg = task_msg_1408;
	return action;
end
