...
function Task_00000129(npcId)
	...
	elseif task:GetTaskSubmitNpc(129) == npcId then
		if Task_Submit_00000129() then
			...
			action.m_ActionMsg = task_msg_001839;
...
function Task_00000129_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001841;
	action.m_ActionMsg = task_msg_001842;
	return action;
end
...
function Task_00000129_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001843;
	action.m_ActionMsg = "";
	return action;
end
