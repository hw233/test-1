...
function Task_00000627(npcId)
	...
	if task:GetTaskAcceptNpc(627) == npcId and Task_Accept_00000627 () then
		...
		action.m_ActionMsg = task_msg_1278;
...
function Task_00000627_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_1281..GetPlayerName(GetPlayer())..task_msg_1282;
	action.m_ActionMsg = task_msg_1283;
	return action;
end
...
function Task_00000627_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_1284;
	action.m_ActionMsg = "";
	return action;
end
