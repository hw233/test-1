...
function Task_00000627(npcId)
	...
	if task:GetTaskAcceptNpc(627) == npcId and Task_Accept_00000627 () then
		...
		action.m_ActionMsg = task_msg_003681;
	elseif task:GetTaskSubmitNpc(627) == npcId then
		if Task_Submit_00000627() then
			...
			action.m_ActionMsg = task_msg_003682;
		elseif task:HasAcceptedTask(627) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 627
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003683;
		end
	end
	return action;
end
...
function Task_00000627_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003684..GetPlayerName(GetPlayer())..task_msg_003685;
	action.m_ActionMsg = task_msg_003686;
	return action;
end
...
function Task_00000627_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_003687;
	action.m_ActionMsg = "";
	return action;
end
