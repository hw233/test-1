...
function Task_00000657(npcId)
	...
	if task:GetTaskAcceptNpc(657) == npcId and Task_Accept_00000657 () then
		...
		action.m_ActionMsg = task_msg_004415;
	elseif task:GetTaskSubmitNpc(657) == npcId then
		if Task_Submit_00000657() then
			...
			action.m_ActionMsg = task_msg_004416;
		elseif task:HasAcceptedTask(657) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 657
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_004417;
		end
	end
	return action;
end
...
function Task_00000657_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004418..GetPlayerName(GetPlayer())..task_msg_004419;
	action.m_ActionMsg = task_msg_004420;
	return action;
end
...
function Task_00000657_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_004421;
	action.m_ActionMsg = "";
	return action;
end
