...
function Task_00000636(npcId)
	...
	elseif task:GetTaskSubmitNpc(636) == npcId then
		if Task_Submit_00000636() then
			...
			action.m_ActionMsg = task_msg_1337;
...
function Task_00000636_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_1339..GetPlayerName(GetPlayer())..task_msg_1340;
...
function Task_00000636_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_1342;
	action.m_ActionMsg = "";
	return action;
end
