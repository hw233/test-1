...
function Task_00000636(npcId)
	...
	elseif task:GetTaskSubmitNpc(636) == npcId then
		if Task_Submit_00000636() then
			...
			action.m_ActionMsg = task_msg_001337;
		elseif task:HasAcceptedTask(636) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 636
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_001338;
		end
	end
	return action;
end
...
function Task_00000636_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001339..GetPlayerName(GetPlayer())..task_msg_001340;
	action.m_ActionMsg = task_msg_001341;
	return action;
end
...
function Task_00000636_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001342;
	action.m_ActionMsg = "";
	return action;
end
