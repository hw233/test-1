...
function Task_00000081(npcId)
	...
	if task:GetTaskAcceptNpc(81) == npcId and Task_Accept_00000081 () then
		...
		action.m_ActionMsg = task_msg_2023;
...
function Task_00000081_step_01()
	...
	action.m_NpcMsg = task_msg_2026;
	action.m_ActionMsg = task_msg_2027;
	return action;
end
...
function Task_00000081_step_02()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_2028;
	action.m_ActionMsg = task_msg_2029;
	return action;
end
