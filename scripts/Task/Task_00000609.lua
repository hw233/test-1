...
function Task_00000609(npcId)
	...
	if task:GetTaskAcceptNpc(609) == npcId and Task_Accept_00000609 () then
		...
		action.m_ActionMsg = task_msg_003423;
	elseif task:GetTaskSubmitNpc(609) == npcId then
		if Task_Submit_00000609() then
			...
			action.m_ActionMsg = task_msg_003424;
		elseif task:HasAcceptedTask(609) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 609
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003425;
		end
	end
	return action;
end
...
function Task_00000609_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003426..GetPlayerName(GetPlayer())..task_msg_003427;
	action.m_ActionMsg = task_msg_003428;
	return action;
end
...
function Task_00000609_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_003429;
	action.m_ActionMsg = "";
	return action;
end
