...
function Task_00000172(npcId)
	...
	elseif task:GetTaskSubmitNpc(172) == npcId then
		if Task_Submit_00000172() then
			...
			action.m_ActionMsg = task_msg_001876;
		elseif task:HasAcceptedTask(172) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 172
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_001877;
		end
	end
	return action;
end
...
function Task_00000172_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001878;
	action.m_ActionMsg = task_msg_001879;
	return action;
end
...
function Task_00000172_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001880;
	action.m_ActionMsg = "";
	return action;
end
