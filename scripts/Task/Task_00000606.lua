...
function Task_00000606(npcId)
	...
	if task:GetTaskAcceptNpc(606) == npcId and Task_Accept_00000606 () then
		...
		action.m_ActionMsg = task_msg_003402;
	elseif task:GetTaskSubmitNpc(606) == npcId then
		if Task_Submit_00000606() then
			...
			action.m_ActionMsg = task_msg_003403;
		elseif task:HasAcceptedTask(606) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 606
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003404;
		end
	end
	return action;
end
...
function Task_00000606_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003405..GetPlayerName(GetPlayer())..task_msg_003406;
	action.m_ActionMsg = task_msg_003407;
	return action;
end
...
function Task_00000606_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_003408;
	action.m_ActionMsg = "";
	return action;
end
