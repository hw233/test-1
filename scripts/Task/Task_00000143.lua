...
function Task_00000143(npcId)
	...
	if task:GetTaskAcceptNpc(143) == npcId and Task_Accept_00000143 () then
		...
		action.m_ActionMsg = task_msg_001657;
...
function Task_00000143_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001660;
	action.m_ActionMsg = task_msg_001661;
	return action;
end
...
function Task_00000143_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001662;
	action.m_ActionMsg = "";
	return action;
end
