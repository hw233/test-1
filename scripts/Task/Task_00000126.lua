...
function Task_00000126_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = "ä¿®é“æŒ‡è·¯æ¼«é•¿ï¼Œç¨æœ‰ä¸æ…å°±å¯èƒ½é™·å…¥ä¸‡åŠ«ä¸å¤ä¹‹åœ°ï¼Œä¸€ä¸ªäººçš„åŠ›é‡æ¯•ç«Ÿæœ‰é™ï¼Œè‹¥å¯ä»¥å¬é›†ä¸€ç¾¤å¿—åŒé“åˆçš„ä¿®é“è€…ç›¸äº’æ‰¶æŒï¼Œå°†ä¼šå¥½å¾ˆå¤šï¼Œ æ‰€ä»¥"..GetPlayerName(GetPlayer()).."ä½ å¯ä»¥åŠ å…¥ä¸€ä¸ªå¸®æ´¾æˆ–è€…è‡ªå·±å¬é›†æ•£ä»™å»ºç«‹ä¸€ä¸ªå¸®æ´¾ã€‚";
	action.m_ActionMsg = "è®©æˆ‘è€ƒè™‘è€ƒè™‘ï¼";
	return action;
end
...
function Task_00000126_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = "å­ºå­å¯æ•™ï¼Œ"..GetPlayerName(GetPlayer()).."ä½ ä¸ä½†ä¾ è‚ä¹‰èƒ†ï¼Œè€Œä¸”è™šæ€€è‹¥è°·å•Šã€‚";
	action.m_ActionMsg = "";
	return action;
end
