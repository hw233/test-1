...
function Task_00000103(npcId)
	...
	if task:GetTaskAcceptNpc(103) == npcId and Task_Accept_00000103 () then
		...
		action.m_ActionMsg = task_msg_000480;
...
function Task_00000103_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000483..GetPlayerName(GetPlayer())..task_msg_000484;
	action.m_ActionMsg = task_msg_000485;
	return action;
end
...
function Task_00000103_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000486;
	action.m_ActionMsg = "";
	return action;
end
