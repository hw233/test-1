...
function Task_00000124(npcId)
	...
	if task:GetTaskAcceptNpc(124) == npcId and Task_Accept_00000124 () then
		...
		action.m_ActionMsg = task_msg_002170;
	elseif task:GetTaskSubmitNpc(124) == npcId then
		if Task_Submit_00000124() then
			...
			action.m_ActionMsg = task_msg_002171;
		elseif task:HasAcceptedTask(124) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 124
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_002172;
		end
	end
	return action;
end
...
function Task_00000124_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_002173..GetPlayerName(GetPlayer())..task_msg_002174;
	action.m_ActionMsg = task_msg_002175;
	return action;
end
...
function Task_00000124_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_002176;
	action.m_ActionMsg = "";
	return action;
end
