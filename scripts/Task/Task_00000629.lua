...
function Task_00000629(npcId)
	...
	if task:GetTaskAcceptNpc(629) == npcId and Task_Accept_00000629 () then
		...
		action.m_ActionMsg = task_msg_1292;
...
function Task_00000629_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_1295..GetPlayerName(GetPlayer())..task_msg_1296;
	action.m_ActionMsg = task_msg_1297;
	return action;
end
...
function Task_00000629_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_1298;
	action.m_ActionMsg = "";
	return action;
end
