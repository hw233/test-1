...
function Task_00000571(npcId)
	...
	if task:GetTaskAcceptNpc(571) == npcId and Task_Accept_00000571 () then
		...
		action.m_ActionMsg = task_msg_001170;
	elseif task:GetTaskSubmitNpc(571) == npcId then
		if Task_Submit_00000571() then
			...
			action.m_ActionMsg = task_msg_001171;
		elseif task:HasAcceptedTask(571) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 571
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_001172;
		end
	end
	return action;
end
...
function Task_00000571_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001173..GetPlayerName(GetPlayer())..task_msg_001174;
...
function Task_00000571_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001176;
	action.m_ActionMsg = "";
	return action;
end
