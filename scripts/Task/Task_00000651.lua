...
function Task_00000651(npcId)
	...
	if task:GetTaskAcceptNpc(651) == npcId and Task_Accept_00000651 () then
		...
		action.m_ActionMsg = task_msg_001867;
	elseif task:GetTaskSubmitNpc(651) == npcId then
		if Task_Submit_00000651() then
			...
			action.m_ActionMsg = task_msg_001868;
		elseif task:HasAcceptedTask(651) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 651
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_001869;
		end
	end
	return action;
end
...
function Task_00000651_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001870;
	action.m_ActionMsg = task_msg_001871;
	return action;
end
...
function Task_00000651_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001872;
	action.m_ActionMsg = "";
	return action;
end
