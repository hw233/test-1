...
function Task_00000600(npcId)
	...
	if task:GetTaskAcceptNpc(600) == npcId and Task_Accept_00000600 () then
		...
		action.m_ActionMsg = task_msg_001025;
...
function Task_00000600_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001028..GetPlayerName(GetPlayer())..task_msg_001029;
...
function Task_00000600_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001031;
	action.m_ActionMsg = "";
	return action;
end
