...
function Task_00000067(npcId)
	...
	if task:GetTaskAcceptNpc(67) == npcId and Task_Accept_00000067 () then
		...
		action.m_ActionMsg = task_msg_004469;
	elseif task:GetTaskSubmitNpc(67) == npcId then
		if Task_Submit_00000067() then
			...
			action.m_ActionMsg = task_msg_004470;
		elseif task:HasAcceptedTask(67) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 67
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_004471;
		end
	end
	return action;
end
...
function Task_00000067_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004472;
	action.m_ActionMsg = task_msg_004473;
	return action;
end
...
function Task_00000067_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004474..GetPlayerName(GetPlayer())..task_msg_004475;
	action.m_ActionMsg = "";
	return action;
end
