...
function Task_00000652(npcId)
	...
	if task:GetTaskAcceptNpc(652) == npcId and Task_Accept_00000652 () then
		...
		action.m_ActionMsg = task_msg_002103;
...
function Task_00000652_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_002106..GetPlayerName(GetPlayer())..task_msg_002107;
...
function Task_00000652_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_002109;
	action.m_ActionMsg = "";
	return action;
end
