...
function Task_00000617(npcId)
	...
	if task:GetTaskAcceptNpc(617) == npcId and Task_Accept_00000617 () then
		...
		action.m_ActionMsg = task_msg_1211;
	elseif task:GetTaskSubmitNpc(617) == npcId then
		if Task_Submit_00000617() then
			...
			action.m_ActionMsg = task_msg_1212;
		elseif task:HasAcceptedTask(617) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 617
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_1213;
		end
	end
	return action;
end
...
function Task_00000617_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_1214;
	action.m_ActionMsg = task_msg_1215;
	return action;
end
...
function Task_00000617_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_1216;
	action.m_ActionMsg = "";
	return action;
end
