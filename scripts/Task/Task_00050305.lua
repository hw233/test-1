...
function Task_00050305_step_01()
	...
	action.m_NpcMsg = GetPlayerName(GetPlayer()).."ï¼Œä½ è¯¥è¿›å…¥å®æˆ˜è®­ç»ƒäº†ï¼Œå»ç«æŠ€åœºå§ï¼Œé‚£é‡Œæœ‰æˆ‘ä»¬é­”æ—æ— æ•°çš„å‹‡å£«åœ¨å’Œå¤©æ—å¯¹æŠ—ï¼Œ ä½ å»è§è¯†è§è¯†å§ã€‚";
	action.m_ActionMsg = "æˆ‘ä¸ä¼šè®©é­”æ—å¤±æœ›çš„ã€‚";
	return action;
end
