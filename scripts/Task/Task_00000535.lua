...
function Task_00000535(npcId)
	...
	if task:GetTaskAcceptNpc(535) == npcId and Task_Accept_00000535 () then
		...
		action.m_ActionMsg = task_msg_1431;
...
function Task_00000535_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_1434..GetPlayerName(GetPlayer())..task_msg_1435;
...
function Task_00000535_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_1437;
	action.m_ActionMsg = "";
	return action;
end
