...
function Task_00000148(npcId)
	...
	if task:GetTaskAcceptNpc(148) == npcId and Task_Accept_00000148 () then
		...
		action.m_ActionMsg = task_msg_004265;
	elseif task:GetTaskSubmitNpc(148) == npcId then
		if Task_Submit_00000148() then
			...
			action.m_ActionMsg = task_msg_004266;
		elseif task:HasAcceptedTask(148) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 148
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_004267;
		end
	end
	return action;
end
...
function Task_00000148_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004268;
	action.m_ActionMsg = task_msg_004269;
	return action;
end
...
function Task_00000148_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_004270;
	action.m_ActionMsg = "";
	return action;
end
