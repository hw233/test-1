...
function Task_00000148(npcId)
	...
	if task:GetTaskAcceptNpc(148) == npcId and Task_Accept_00000148 () then
		...
		action.m_ActionMsg = task_msg_001970;
...
function Task_00000148_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001973;
	action.m_ActionMsg = task_msg_001974;
	return action;
end
...
function Task_00000148_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001975;
	action.m_ActionMsg = "";
	return action;
end
