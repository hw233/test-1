...
function Task_00000072(npcId)
	...
	if task:GetTaskAcceptNpc(72) == npcId and Task_Accept_00000072 () then
		...
		action.m_ActionMsg = task_msg_002114;
	elseif task:GetTaskSubmitNpc(72) == npcId then
		...
		elseif task:HasAcceptedTask(72) then
			...
			action.m_ActionMsg = task_msg_002116;
		end
	end
	return action;
end
...
function Task_00000072_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_002117;
	action.m_ActionMsg = task_msg_002118;
	return action;
end
...
function Task_00000072_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_002119;
	action.m_ActionMsg = "";
	return action;
end
