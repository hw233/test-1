...
function Task_00000654(npcId)
	...
	if task:GetTaskAcceptNpc(654) == npcId and Task_Accept_00000654 () then
		...
		action.m_ActionMsg = task_msg_002004;
	elseif task:GetTaskSubmitNpc(654) == npcId then
		if Task_Submit_00000654() then
			...
			action.m_ActionMsg = task_msg_002005;
...
function Task_00000654_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_002007..GetPlayerName(GetPlayer())..task_msg_002008;
	action.m_ActionMsg = task_msg_002009;
	return action;
end
...
function Task_00000654_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_002010;
	action.m_ActionMsg = "";
	return action;
end
