...
function Task_00000654(npcId)
	...
	elseif task:GetTaskSubmitNpc(654) == npcId then
		...
		elseif task:HasAcceptedTask(654) then
			...
			action.m_ActionMsg = task_msg_001889;
		end
	end
	return action;
end
...
function Task_00000654_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001890..GetPlayerName(GetPlayer())..task_msg_001891;
	action.m_ActionMsg = task_msg_001892;
	return action;
end
...
function Task_00000654_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001893;
	action.m_ActionMsg = "";
	return action;
end
