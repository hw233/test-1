...
function Task_00000654(npcId)
	...
	if task:GetTaskAcceptNpc(654) == npcId and Task_Accept_00000654 () then
		...
		action.m_ActionMsg = task_msg_004394;
	elseif task:GetTaskSubmitNpc(654) == npcId then
		if Task_Submit_00000654() then
			...
			action.m_ActionMsg = task_msg_004395;
		elseif task:HasAcceptedTask(654) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 654
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_004396;
		end
	end
	return action;
end
...
function Task_00000654_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004397..GetPlayerName(GetPlayer())..task_msg_004398;
	action.m_ActionMsg = task_msg_004399;
	return action;
end
...
function Task_00000654_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_004400;
	action.m_ActionMsg = "";
	return action;
end
