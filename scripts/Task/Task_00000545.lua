...
function Task_00000545(npcId)
	...
	elseif task:GetTaskSubmitNpc(545) == npcId then
		...
		elseif task:HasAcceptedTask(545) then
			...
			action.m_ActionMsg = task_msg_001459;
		end
	end
	return action;
end
...
function Task_00000545_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001460;
	action.m_ActionMsg = task_msg_001461;
	return action;
end
...
function Task_00000545_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001462;
	action.m_ActionMsg = "";
	return action;
end
