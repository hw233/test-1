...
function Task_00000545(npcId)
	...
	if task:GetTaskAcceptNpc(545) == npcId and Task_Accept_00000545 () then
		...
		action.m_ActionMsg = task_msg_003897;
	elseif task:GetTaskSubmitNpc(545) == npcId then
		if Task_Submit_00000545() then
			...
			action.m_ActionMsg = task_msg_003898;
		elseif task:HasAcceptedTask(545) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 545
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003899;
		end
	end
	return action;
end
...
function Task_00000545_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003900;
	action.m_ActionMsg = task_msg_003901;
	return action;
end
...
function Task_00000545_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_003902;
	action.m_ActionMsg = "";
	return action;
end
