...
function Task_00000513(npcId)
	...
	elseif task:GetTaskSubmitNpc(513) == npcId then
		if Task_Submit_00000513() then
			...
			action.m_ActionMsg = task_msg_000713;
		elseif task:HasAcceptedTask(513) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 513
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_000714;
		end
	end
	return action;
end
...
function Task_00000513_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000715;
	action.m_ActionMsg = task_msg_000716;
	return action;
end
...
function Task_00000513_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000717;
	action.m_ActionMsg = "";
	return action;
end
