...
function Task_00000128_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_2172..GetPlayerName(GetPlayer())..task_msg_2173;
	action.m_ActionMsg = task_msg_2174;
	return action;
end
...
function Task_00000128_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_2175;
	action.m_ActionMsg = "";
	return action;
end
