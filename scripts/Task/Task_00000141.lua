...
function Task_00000141(npcId)
	...
	if task:GetTaskAcceptNpc(141) == npcId and Task_Accept_00000141 () then
		...
		action.m_ActionMsg = task_msg_001631;
	elseif task:GetTaskSubmitNpc(141) == npcId then
		if Task_Submit_00000141() then
			...
			action.m_ActionMsg = task_msg_001632;
		elseif task:HasAcceptedTask(141) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 141
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_001633;
		end
	end
	return action;
end
...
function Task_00000141_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001634;
	action.m_ActionMsg = task_msg_001635;
	return action;
end
...
function Task_00000141_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001636;
	action.m_ActionMsg = "";
	return action;
end
