...
function Task_00000080(npcId)
	...
	if task:GetTaskAcceptNpc(80) == npcId and Task_Accept_00000080 () then
		...
		action.m_ActionMsg = task_msg_002167;
	elseif task:GetTaskSubmitNpc(80) == npcId then
		...
		elseif task:HasAcceptedTask(80) then
			...
			action.m_ActionMsg = task_msg_002169;
		end
	end
	return action;
end
...
function Task_00000080_step_01()
	...
	action.m_NpcMsg = task_msg_002170;
...
function Task_00000080_step_02()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_002172;
	action.m_ActionMsg = task_msg_002173;
	return action;
end
...
function Task_00000080_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_002174;
	action.m_ActionMsg = "";
	return action;
end
