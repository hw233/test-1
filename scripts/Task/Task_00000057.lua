...
function Task_00000057(npcId)
	...
	if task:GetTaskAcceptNpc(57) == npcId and Task_Accept_00000057 () then
		...
		action.m_ActionMsg = task_msg_001683;
	elseif task:GetTaskSubmitNpc(57) == npcId then
		...
		elseif task:HasAcceptedTask(57) then
			...
			action.m_ActionMsg = task_msg_001685;
		end
	end
	return action;
end
...
function Task_00000057_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001686;
	action.m_ActionMsg = task_msg_001687;
	return action;
end
...
function Task_00000057_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001688;
	action.m_ActionMsg = "";
	return action;
end
