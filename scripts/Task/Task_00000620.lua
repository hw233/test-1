...
function Task_00000620(npcId)
	...
	if task:GetTaskAcceptNpc(620) == npcId and Task_Accept_00000620 () then
		...
		action.m_ActionMsg = task_msg_003633;
	elseif task:GetTaskSubmitNpc(620) == npcId then
		if Task_Submit_00000620() then
			...
			action.m_ActionMsg = task_msg_003634;
		elseif task:HasAcceptedTask(620) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 620
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003635;
		end
	end
	return action;
end
...
function Task_00000620_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003636..GetPlayerName(GetPlayer())..task_msg_003637;
	action.m_ActionMsg = task_msg_003638;
	return action;
end
...
function Task_00000620_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_003639;
	action.m_ActionMsg = "";
	return action;
end
