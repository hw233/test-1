...
function Task_00000620(npcId)
	...
	elseif task:GetTaskSubmitNpc(620) == npcId then
		if Task_Submit_00000620() then
			...
			action.m_ActionMsg = task_msg_001194;
...
function Task_00000620_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001196..GetPlayerName(GetPlayer())..task_msg_001197;
	action.m_ActionMsg = task_msg_001198;
	return action;
end
...
function Task_00000620_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001199;
	action.m_ActionMsg = "";
	return action;
end
