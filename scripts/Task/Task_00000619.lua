...
function Task_00000619(npcId)
	...
	if task:GetTaskAcceptNpc(619) == npcId and Task_Accept_00000619 () then
		...
		action.m_ActionMsg = task_msg_003626;
	elseif task:GetTaskSubmitNpc(619) == npcId then
		if Task_Submit_00000619() then
			...
			action.m_ActionMsg = task_msg_003627;
		elseif task:HasAcceptedTask(619) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 619
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003628;
		end
	end
	return action;
end
...
function Task_00000619_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003629..GetPlayerName(GetPlayer())..task_msg_003630;
	action.m_ActionMsg = task_msg_003631;
	return action;
end
...
function Task_00000619_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_003632;
	action.m_ActionMsg = "";
	return action;
end
