...
function Task_00000104(npcId)
	...
	if task:GetTaskAcceptNpc(104) == npcId and Task_Accept_00000104 () then
		...
		action.m_ActionMsg = task_msg_000487;
...
function Task_00000104_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000490..GetPlayerName(GetPlayer())..task_msg_000491;
	action.m_ActionMsg = task_msg_000492;
	return action;
end
...
function Task_00000104_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000493;
	action.m_ActionMsg = "";
	return action;
end
