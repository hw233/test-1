...
function Task_00000104(npcId)
	...
	if task:GetTaskAcceptNpc(104) == npcId and Task_Accept_00000104 () then
		...
		action.m_ActionMsg = task_msg_000481;
	elseif task:GetTaskSubmitNpc(104) == npcId then
		if Task_Submit_00000104() then
			...
			action.m_ActionMsg = task_msg_000482;
		elseif task:HasAcceptedTask(104) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 104
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_000483;
		end
	end
	return action;
end
...
function Task_00000104_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000484..GetPlayerName(GetPlayer())..task_msg_000485;
	action.m_ActionMsg = task_msg_000486;
	return action;
end
...
function Task_00000104_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000487;
	action.m_ActionMsg = "";
	return action;
end
