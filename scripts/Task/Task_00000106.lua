...
function Task_00000106(npcId)
	...
	elseif task:GetTaskSubmitNpc(106) == npcId then
		...
		elseif task:HasAcceptedTask(106) then
			...
			action.m_ActionMsg = task_msg_490;
		end
	end
	return action;
end
...
function Task_00000106_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_491..GetPlayerName(GetPlayer())..task_msg_492;
	action.m_ActionMsg = task_msg_493;
	return action;
end
...
function Task_00000106_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_494;
	action.m_ActionMsg = "";
	return action;
end
