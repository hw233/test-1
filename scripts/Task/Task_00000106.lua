...
function Task_00000106(npcId)
	...
	if task:GetTaskAcceptNpc(106) == npcId and Task_Accept_00000106 () then
		...
		action.m_ActionMsg = task_msg_000488;
	elseif task:GetTaskSubmitNpc(106) == npcId then
		if Task_Submit_00000106() then
			...
			action.m_ActionMsg = task_msg_000489;
		elseif task:HasAcceptedTask(106) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 106
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_000490;
		end
	end
	return action;
end
...
function Task_00000106_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000491..GetPlayerName(GetPlayer())..task_msg_000492;
	action.m_ActionMsg = task_msg_000493;
	return action;
end
...
function Task_00000106_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_000494;
	action.m_ActionMsg = "";
	return action;
end
