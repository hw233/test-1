...
function Task_00000572(npcId)
	...
	if task:GetTaskAcceptNpc(572) == npcId and Task_Accept_00000572 () then
		...
		action.m_ActionMsg = task_msg_003580;
	elseif task:GetTaskSubmitNpc(572) == npcId then
		if Task_Submit_00000572() then
			...
			action.m_ActionMsg = task_msg_003581;
		elseif task:HasAcceptedTask(572) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 572
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003582;
		end
	end
	return action;
end
...
function Task_00000572_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003583;
	action.m_ActionMsg = task_msg_003584;
	return action;
end
...
function Task_00000572_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_003585;
	action.m_ActionMsg = "";
	return action;
end
