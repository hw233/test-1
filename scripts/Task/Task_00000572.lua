...
function Task_00000572(npcId)
	...
	elseif task:GetTaskSubmitNpc(572) == npcId then
		if Task_Submit_00000572() then
			...
			action.m_ActionMsg = task_msg_001141;
		elseif task:HasAcceptedTask(572) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 572
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_001142;
		end
	end
	return action;
end
...
function Task_00000572_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001143;
	action.m_ActionMsg = task_msg_001144;
	return action;
end
...
function Task_00000572_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001145;
	action.m_ActionMsg = "";
	return action;
end
