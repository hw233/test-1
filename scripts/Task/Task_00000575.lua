...
function Task_00000575(npcId)
	...
	elseif task:GetTaskSubmitNpc(575) == npcId then
		...
		elseif task:HasAcceptedTask(575) then
			...
			action.m_ActionMsg = task_msg_001199;
		end
	end
	return action;
end
...
function Task_00000575_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001200..GetPlayerName(GetPlayer())..task_msg_001201;
...
function Task_00000575_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001203;
	action.m_ActionMsg = "";
	return action;
end
