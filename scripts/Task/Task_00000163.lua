...
function Task_00000163(npcId)
	...
	if task:GetTaskAcceptNpc(163) == npcId and Task_Accept_00000163 () then
		...
		action.m_ActionMsg = task_msg_001779;
	elseif task:GetTaskSubmitNpc(163) == npcId then
		...
		elseif task:HasAcceptedTask(163) then
			...
			action.m_ActionMsg = task_msg_001781;
		end
	end
	return action;
end
...
function Task_00000163_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001782;
	action.m_ActionMsg = task_msg_001783;
	return action;
end
...
function Task_00000163_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001784;
	action.m_ActionMsg = "";
	return action;
end
