...
function Task_00000110(npcId)
	...
	if task:GetTaskAcceptNpc(110) == npcId and Task_Accept_00000110 () then
		...
		action.m_ActionMsg = task_msg_003024;
	elseif task:GetTaskSubmitNpc(110) == npcId then
		if Task_Submit_00000110() then
			...
			action.m_ActionMsg = task_msg_003025;
		elseif task:HasAcceptedTask(110) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 110
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003026;
		end
	end
	return action;
end
...
function Task_00000110_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003027..GetPlayerName(GetPlayer())..task_msg_003028;
	action.m_ActionMsg = task_msg_003029;
	return action;
end
...
function Task_00000110_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003030;
	action.m_ActionMsg = "";
	return action;
end
