...
function Task_00000110(npcId)
	...
	if task:GetTaskAcceptNpc(110) == npcId and Task_Accept_00000110 () then
		...
		action.m_ActionMsg = task_msg_000530;
...
function Task_00000110_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000533..GetPlayerName(GetPlayer())..task_msg_000534;
	action.m_ActionMsg = task_msg_000535;
	return action;
end
...
function Task_00000110_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000536;
	action.m_ActionMsg = "";
	return action;
end
