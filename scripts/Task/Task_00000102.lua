...
function Task_00000102(npcId)
	...
	if task:GetTaskAcceptNpc(102) == npcId and Task_Accept_00000102 () then
		...
		action.m_ActionMsg = task_msg_473;
...
function Task_00000102_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_476..GetPlayerName(GetPlayer())..task_msg_477;
	action.m_ActionMsg = task_msg_478;
	return action;
end
