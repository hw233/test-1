...
function Task_00000122(npcId)
	...
	if task:GetTaskAcceptNpc(122) == npcId and Task_Accept_00000122 () then
		...
		action.m_ActionMsg = task_msg_003467;
	elseif task:GetTaskSubmitNpc(122) == npcId then
		if Task_Submit_00000122() then
			...
			action.m_ActionMsg = task_msg_003468;
		elseif task:HasAcceptedTask(122) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 122
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003469;
		end
	end
	return action;
end
...
function Task_00000122_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003470;
	action.m_ActionMsg = task_msg_003471;
	return action;
end
...
function Task_00000122_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003472..GetPlayerName(GetPlayer())..task_msg_003473;
	action.m_ActionMsg = "";
	return action;
end
