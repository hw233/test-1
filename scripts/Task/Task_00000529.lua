...
function Task_00000529(npcId)
	...
	if task:GetTaskAcceptNpc(529) == npcId and Task_Accept_00000529 () then
		...
		action.m_ActionMsg = task_msg_1389;
...
function Task_00000529_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_1392..GetPlayerName(GetPlayer())..task_msg_1393;
	action.m_ActionMsg = task_msg_1394;
	return action;
end
...
function Task_00000529_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_1395;
	action.m_ActionMsg = "";
	return action;
end
