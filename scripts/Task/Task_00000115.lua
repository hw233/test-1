...
function Task_00000115(npcId)
	...
	if task:GetTaskAcceptNpc(115) == npcId and Task_Accept_00000115 () then
		...
		action.m_ActionMsg = task_msg_003048;
	elseif task:GetTaskSubmitNpc(115) == npcId then
		if Task_Submit_00000115() then
			...
			action.m_ActionMsg = task_msg_003049;
		elseif task:HasAcceptedTask(115) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 115
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003050;
		end
	end
	return action;
end
...
function Task_00000115_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_003051;
	action.m_ActionMsg = task_msg_003052;
	return action;
end
...
function Task_00000115_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003053;
	action.m_ActionMsg = "";
	return action;
end
