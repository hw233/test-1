...
function Task_00000121(npcId)
	...
	if task:GetTaskAcceptNpc(121) == npcId and Task_Accept_00000121 () then
		...
		action.m_ActionMsg = task_msg_003074;
	elseif task:GetTaskSubmitNpc(121) == npcId then
		if Task_Submit_00000121() then
			...
			action.m_ActionMsg = task_msg_003075;
		elseif task:HasAcceptedTask(121) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 121
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003076;
		end
	end
	return action;
end
...
function Task_00000121_step_01()
	...
	action.m_NpcMsg = task_msg_003077;
	action.m_ActionMsg = task_msg_003078;
	return action;
end
...
function Task_00000121_step_02()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003079..GetPlayerName(GetPlayer())..task_msg_003080;
	action.m_ActionMsg = task_msg_003081;
	return action;
end
...
function Task_00000121_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003082..GetPlayerName(GetPlayer())..task_msg_003083;
	action.m_ActionMsg = "";
	return action;
end
