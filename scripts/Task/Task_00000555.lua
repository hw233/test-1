...
function Task_00000555(npcId)
	...
	if task:GetTaskAcceptNpc(555) == npcId and Task_Accept_00000555 () then
		...
		action.m_ActionMsg = task_msg_795;
	elseif task:GetTaskSubmitNpc(555) == npcId then
		...
		elseif task:HasAcceptedTask(555) then
			...
			action.m_ActionMsg = task_msg_797;
		end
	end
	return action;
end
...
function Task_00000555_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_798..GetPlayerName(GetPlayer())..task_msg_799;
...
function Task_00000555_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_801;
	action.m_ActionMsg = "";
	return action;
end
