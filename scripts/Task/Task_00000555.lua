...
function Task_00000555(npcId)
	...
	if task:GetTaskAcceptNpc(555) == npcId and Task_Accept_00000555 () then
		...
		action.m_ActionMsg = task_msg_003270;
	elseif task:GetTaskSubmitNpc(555) == npcId then
		if Task_Submit_00000555() then
			...
			action.m_ActionMsg = task_msg_003271;
		elseif task:HasAcceptedTask(555) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 555
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003272;
		end
	end
	return action;
end
...
function Task_00000555_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003273..GetPlayerName(GetPlayer())..task_msg_003274;
	action.m_ActionMsg = task_msg_003275;
	return action;
end
...
function Task_00000555_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_003276;
	action.m_ActionMsg = "";
	return action;
end
