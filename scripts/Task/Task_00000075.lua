...
function Task_00000075(npcId)
	...
	if task:GetTaskAcceptNpc(75) == npcId and Task_Accept_00000075 () then
		...
		action.m_ActionMsg = task_msg_004505;
	elseif task:GetTaskSubmitNpc(75) == npcId then
		if Task_Submit_00000075() then
			...
			action.m_ActionMsg = task_msg_004506;
		elseif task:HasAcceptedTask(75) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 75
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_004507;
		end
	end
	return action;
end
...
function Task_00000075_step_01()
	...
	action.m_NpcMsg = task_msg_004508;
	action.m_ActionMsg = task_msg_004509;
	return action;
end
...
function Task_00000075_step_02()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004510;
	action.m_ActionMsg = task_msg_004511;
	return action;
end
...
function Task_00000075_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004512;
	action.m_ActionMsg = "";
	return action;
end
