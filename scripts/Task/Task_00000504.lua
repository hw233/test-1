...
function Task_00000504(npcId)
	...
	if task:GetTaskAcceptNpc(504) == npcId and Task_Accept_00000504 () then
		...
		action.m_ActionMsg = task_msg_003125;
	elseif task:GetTaskSubmitNpc(504) == npcId then
		if Task_Submit_00000504() then
			...
			action.m_ActionMsg = task_msg_003126;
		elseif task:HasAcceptedTask(504) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 504
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003127;
		end
	end
	return action;
end
...
function Task_00000504_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003128..GetPlayerName(GetPlayer())..task_msg_003129;
	action.m_ActionMsg = task_msg_003130;
	return action;
end
...
function Task_00000504_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_003131;
	action.m_ActionMsg = "";
	return action;
end
