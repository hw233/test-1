...
function Task_00000570(npcId)
	...
	if task:GetTaskAcceptNpc(570) == npcId and Task_Accept_00000570 () then
		...
		action.m_ActionMsg = task_msg_003368;
	elseif task:GetTaskSubmitNpc(570) == npcId then
		if Task_Submit_00000570() then
			...
			action.m_ActionMsg = task_msg_003369;
		elseif task:HasAcceptedTask(570) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 570
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003370;
		end
	end
	return action;
end
...
function Task_00000570_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003371;
	action.m_ActionMsg = task_msg_003372;
	return action;
end
...
function Task_00000570_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_003373;
	action.m_ActionMsg = "";
	return action;
end
