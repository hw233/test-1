...
function Task_00000570(npcId)
	...
	if task:GetTaskAcceptNpc(570) == npcId and Task_Accept_00000570 () then
		...
		action.m_ActionMsg = task_msg_000861;
...
function Task_00000570_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000864;
	action.m_ActionMsg = task_msg_000865;
	return action;
end
...
function Task_00000570_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_000866;
	action.m_ActionMsg = "";
	return action;
end
