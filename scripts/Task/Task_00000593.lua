...
function Task_00000593(npcId)
	...
	elseif task:GetTaskSubmitNpc(593) == npcId then
		...
		elseif task:HasAcceptedTask(593) then
			...
			action.m_ActionMsg = task_msg_001508;
		end
	end
	return action;
end
...
function Task_00000593_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001509..GetPlayerName(GetPlayer())..task_msg_001510;
	action.m_ActionMsg = task_msg_001511;
	return action;
end
...
function Task_00000593_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001512;
	action.m_ActionMsg = "";
	return action;
end
