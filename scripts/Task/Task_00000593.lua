...
function Task_00000593(npcId)
	...
	if task:GetTaskAcceptNpc(593) == npcId and Task_Accept_00000593 () then
		...
		action.m_ActionMsg = task_msg_004013;
	elseif task:GetTaskSubmitNpc(593) == npcId then
		if Task_Submit_00000593() then
			...
			action.m_ActionMsg = task_msg_004014;
		elseif task:HasAcceptedTask(593) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 593
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_004015;
		end
	end
	return action;
end
...
function Task_00000593_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004016..GetPlayerName(GetPlayer())..task_msg_004017;
	action.m_ActionMsg = task_msg_004018;
	return action;
end
...
function Task_00000593_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_004019;
	action.m_ActionMsg = "";
	return action;
end
