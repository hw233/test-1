...
function Task_00000593(npcId)
	...
	if task:GetTaskAcceptNpc(593) == npcId and Task_Accept_00000593 () then
		...
		action.m_ActionMsg = task_msg_1500;
	elseif task:GetTaskSubmitNpc(593) == npcId then
		if Task_Submit_00000593() then
			...
			action.m_ActionMsg = task_msg_1501;
		elseif task:HasAcceptedTask(593) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 593
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_1502;
		end
	end
	return action;
end
...
function Task_00000593_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_1503..GetPlayerName(GetPlayer())..task_msg_1504;
	action.m_ActionMsg = task_msg_1505;
	return action;
end
...
function Task_00000593_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_1506;
	action.m_ActionMsg = "";
	return action;
end
