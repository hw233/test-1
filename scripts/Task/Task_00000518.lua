...
function Task_00000518(npcId)
	...
	if task:GetTaskAcceptNpc(518) == npcId and Task_Accept_00000518 () then
		...
		action.m_ActionMsg = task_msg_003217;
	elseif task:GetTaskSubmitNpc(518) == npcId then
		if Task_Submit_00000518() then
			...
			action.m_ActionMsg = task_msg_003218;
		elseif task:HasAcceptedTask(518) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 518
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003219;
		end
	end
	return action;
end
...
function Task_00000518_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003220..GetPlayerName(GetPlayer())..task_msg_003221;
	action.m_ActionMsg = task_msg_003222;
	return action;
end
...
function Task_00000518_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003223;
	action.m_ActionMsg = "";
	return action;
end
