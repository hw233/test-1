...
function Task_00000024(npcId)
	...
	if task:GetTaskAcceptNpc(24) == npcId and Task_Accept_00000024 () then
		...
		action.m_ActionMsg = task_msg_004422;
	elseif task:GetTaskSubmitNpc(24) == npcId then
		if Task_Submit_00000024() then
			...
			action.m_ActionMsg = task_msg_004423;
		elseif task:HasAcceptedTask(24) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 24
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_004424;
		end
	end
	return action;
end
...
function Task_00000024_step_01()
	...
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_004425;
	action.m_ActionMsg = task_msg_004426;
	return action;
end
...
function Task_00000024_step_02()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004427;
	action.m_ActionMsg = task_msg_004428;
	return action;
end
...
function Task_00000024_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004429;
	action.m_ActionMsg = "";
	return action;
end
