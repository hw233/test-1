...
function Task_00000024(npcId)
	...
	elseif task:GetTaskSubmitNpc(24) == npcId then
		if Task_Submit_00000024() then
			...
			action.m_ActionMsg = task_msg_002033;
...
function Task_00000024_step_01()
	...
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_002035;
	action.m_ActionMsg = task_msg_002036;
	return action;
end
...
function Task_00000024_step_02()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_002037;
	action.m_ActionMsg = task_msg_002038;
	return action;
end
...
function Task_00000024_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_002039;
	action.m_ActionMsg = "";
	return action;
end
