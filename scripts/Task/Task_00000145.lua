...
function Task_00000145(npcId)
	...
	if task:GetTaskAcceptNpc(145) == npcId and Task_Accept_00000145 () then
		...
		action.m_ActionMsg = task_msg_004271;
	elseif task:GetTaskSubmitNpc(145) == npcId then
		if Task_Submit_00000145() then
			...
			action.m_ActionMsg = task_msg_004272;
		elseif task:HasAcceptedTask(145) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 145
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_004273;
		end
	end
	return action;
end
...
function Task_00000145_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004274;
	action.m_ActionMsg = task_msg_004275;
	return action;
end
...
function Task_00000145_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_004276;
	action.m_ActionMsg = "";
	return action;
end
