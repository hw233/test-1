...
function Task_00000021(npcId)
	...
	if task:GetTaskAcceptNpc(21) == npcId and Task_Accept_00000021 () then
		...
		action.m_ActionMsg = task_msg_002684;
	elseif task:GetTaskSubmitNpc(21) == npcId then
		if Task_Submit_00000021() then
			...
			action.m_ActionMsg = task_msg_002685;
		elseif task:HasAcceptedTask(21) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 21
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_002686;
		end
	end
	return action;
end
...
function Task_00000021_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_002687;
	action.m_ActionMsg = task_msg_002688;
	return action;
end
...
function Task_00000021_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_002689;
	action.m_ActionMsg = "";
	return action;
end
