...
function Task_00000550(npcId)
	...
	if task:GetTaskAcceptNpc(550) == npcId and Task_Accept_00000550 () then
		...
		action.m_ActionMsg = task_msg_000729;
	elseif task:GetTaskSubmitNpc(550) == npcId then
		if Task_Submit_00000550() then
			...
			action.m_ActionMsg = task_msg_000730;
		elseif task:HasAcceptedTask(550) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 550
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_000731;
		end
	end
	return action;
end
...
function Task_00000550_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_000732..GetPlayerName(GetPlayer())..task_msg_000733;
	action.m_ActionMsg = task_msg_000734;
	return action;
end
...
function Task_00000550_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_000735;
	action.m_ActionMsg = "";
	return action;
end
