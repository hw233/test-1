...
function Task_00000550(npcId)
	...
	if task:GetTaskAcceptNpc(550) == npcId and Task_Accept_00000550 () then
		...
		action.m_ActionMsg = task_msg_761;
	elseif task:GetTaskSubmitNpc(550) == npcId then
		if Task_Submit_00000550() then
			...
			action.m_ActionMsg = task_msg_762;
...
function Task_00000550_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_764..GetPlayerName(GetPlayer())..task_msg_765;
	action.m_ActionMsg = task_msg_766;
	return action;
end
...
function Task_00000550_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_767;
	action.m_ActionMsg = "";
	return action;
end
