...
function Task_00000631(npcId)
	...
	if task:GetTaskAcceptNpc(631) == npcId and Task_Accept_00000631 () then
		...
		action.m_ActionMsg = task_msg_001202;
	elseif task:GetTaskSubmitNpc(631) == npcId then
		if Task_Submit_00000631() then
			...
			action.m_ActionMsg = task_msg_001203;
		elseif task:HasAcceptedTask(631) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 631
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_001204;
		end
	end
	return action;
end
...
function Task_00000631_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001205;
	action.m_ActionMsg = task_msg_001206;
	return action;
end
...
function Task_00000631_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001207;
	action.m_ActionMsg = "";
	return action;
end
