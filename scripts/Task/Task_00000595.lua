...
function Task_00000595(npcId)
	...
	elseif task:GetTaskSubmitNpc(595) == npcId then
		if Task_Submit_00000595() then
			...
			action.m_ActionMsg = task_msg_001625;
...
function Task_00000595_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001627..GetPlayerName(GetPlayer())..task_msg_001628;
	action.m_ActionMsg = task_msg_001629;
	return action;
end
...
function Task_00000595_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001630;
	action.m_ActionMsg = "";
	return action;
end
