...
function Task_00000595(npcId)
	...
	if task:GetTaskAcceptNpc(595) == npcId and Task_Accept_00000595 () then
		...
		action.m_ActionMsg = task_msg_001520;
	elseif task:GetTaskSubmitNpc(595) == npcId then
		...
		elseif task:HasAcceptedTask(595) then
			...
			action.m_ActionMsg = task_msg_001522;
		end
	end
	return action;
end
...
function Task_00000595_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001523..GetPlayerName(GetPlayer())..task_msg_001524;
...
function Task_00000595_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001526;
	action.m_ActionMsg = "";
	return action;
end
