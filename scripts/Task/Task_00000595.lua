...
function Task_00000595(npcId)
	...
	if task:GetTaskAcceptNpc(595) == npcId and Task_Accept_00000595 () then
		...
		action.m_ActionMsg = task_msg_004027;
	elseif task:GetTaskSubmitNpc(595) == npcId then
		if Task_Submit_00000595() then
			...
			action.m_ActionMsg = task_msg_004028;
		elseif task:HasAcceptedTask(595) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 595
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_004029;
		end
	end
	return action;
end
...
function Task_00000595_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_004030..GetPlayerName(GetPlayer())..task_msg_004031;
	action.m_ActionMsg = task_msg_004032;
	return action;
end
...
function Task_00000595_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_004033;
	action.m_ActionMsg = "";
	return action;
end
