...
function Task_00000630(npcId)
	...
	if task:GetTaskAcceptNpc(630) == npcId and Task_Accept_00000630 () then
		...
		action.m_ActionMsg = task_msg_001262;
...
function Task_00000630_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001265..GetPlayerName(GetPlayer())..task_msg_001266;
	action.m_ActionMsg = task_msg_001267;
	return action;
end
...
function Task_00000630_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001268;
	action.m_ActionMsg = "";
	return action;
end
