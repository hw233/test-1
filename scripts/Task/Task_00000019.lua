...
function Task_00000019_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = "è›‡å¦–ç¡®å®æ¯”è¾ƒå‰å®³ï¼Œä¸è¿‡æˆ‘æ—©å·²å‡†å¤‡äº†åº”ä»˜ä¹‹æ³•ï¼Œç‰¹åœ°ä»é»„å±±çš„é¤éœå¤§å¸ˆé‚£é‡Œå€Ÿæ¥é‡‘é³èœˆèš£ï¼Œå®ƒå¯æ˜¯è›‡å¦–çš„å…‹æ˜Ÿã€‚æ¶ˆç­è¿™åªè›‡å¦–ä¸åœ¨è¯ä¸‹ï¼Œ<name>ä½ è¿™å°±å’Œæˆ‘ä»¬ä¸€èµ·å»å§ã€‚";
...
function Task_00000019_accept()
	...
	RunAutoBattleAction(player,4096,0);
	task:AddTaskStep(19);
