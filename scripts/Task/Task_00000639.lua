...
function Task_00000639(npcId)
	...
	if task:GetTaskAcceptNpc(639) == npcId and Task_Accept_00000639 () then
		...
		action.m_ActionMsg = task_msg_003758;
	elseif task:GetTaskSubmitNpc(639) == npcId then
		if Task_Submit_00000639() then
			...
			action.m_ActionMsg = task_msg_003759;
		elseif task:HasAcceptedTask(639) then
			action.m_ActionType = 0x0001;
			action.m_ActionID = 639
			action.m_ActionToken = 0;
			action.m_ActionStep = 0;
			action.m_ActionMsg = task_msg_003760;
		end
	end
	return action;
end
...
function Task_00000639_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_003761..GetPlayerName(GetPlayer())..task_msg_003762;
	action.m_ActionMsg = task_msg_003763;
	return action;
end
...
function Task_00000639_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_003764;
	action.m_ActionMsg = "";
	return action;
end
