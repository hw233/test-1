...
function Task_00000639(npcId)
	...
	if task:GetTaskAcceptNpc(639) == npcId and Task_Accept_00000639 () then
		...
		action.m_ActionMsg = task_msg_001318;
	elseif task:GetTaskSubmitNpc(639) == npcId then
		if Task_Submit_00000639() then
			...
			action.m_ActionMsg = task_msg_001319;
...
function Task_00000639_step_01()
	...
	action.m_ActionStep = 0;
	action.m_NpcMsg = task_msg_001321..GetPlayerName(GetPlayer())..task_msg_001322;
	action.m_ActionMsg = task_msg_001323;
	return action;
end
...
function Task_00000639_step_10()
	...
	action.m_ActionToken = 3;
	action.m_ActionStep = 0;
	action.m_NpcMsg = GetPlayerName(GetPlayer())..task_msg_001324;
	action.m_ActionMsg = "";
	return action;
end
