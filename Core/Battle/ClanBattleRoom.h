...
namespace Battle
{
    class ClanBattleRoom
    {
        public:
            ...
            void InsertFighterNum(UInt8 forceId,UInt8 num) { force2num.insert(pair<UInt8,UInt32>(forceId,num));}
            UInt32 GetNum(UInt8 forceId) { return force2num[forceId];}
            void InsertClans(UInt8 forceId,std::vector<UInt32>clans) { force2clans.insert(pair<UInt8,std::vector<UInt32>>(forceId,clans));}
    ...
    class ClanBattleRoomManager
    {
        public:
            ...
            void loadBattleRoom(UInt32 roomId,UInt8 battleId,UInt8 forceId,std::vector<UInt32> vecClan,UInt8 fighterNum);
