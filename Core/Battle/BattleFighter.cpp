...
BattleFighter::BattleFighter(Script::BattleFormula * bf, GObject::Fighter * f, UInt8 side, UInt8 pos):
   ...
   ,_bActCnt(0), _immune3(0), _revivalCntSkill(NULL), _revivalCnt(0), _revivalCntMax(0), _prudentSkill(NULL), _HitrateMinus(0), _silkwormSkill(NULL), _silkwormCnt(0)
{
...
void BattleFighter::updatePassiveSkillRevival100()
{
    const GData::SkillBase* passiveSkill = NULL;
    size_t skillIdx = 0;
    while(NULL != (passiveSkill = getPassiveSkillRevival100(skillIdx)))
    {
