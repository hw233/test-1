...
private:
    ...
    BattleFighter* getTherapyTarget3(BattleFighter* bf, UInt8 * excepts, size_t exceptCount, bool isFirst = false);
    ...
    void doSkillEffectExtra_Dispeerless(BattleFighter* bf, int target_side, int target_pos, const GData::SkillBase* skill, size_t eftIdx);
...
private:
    ...
    void doBMTLDispearAttack(BattleFighter* bf);
};
