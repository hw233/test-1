...
public:
    ...
    inline float getExtraCriticalDef() { return 1/*_attrExtraEquip.criticaldef*/; } //暴击抗性
    inline float getExtraPierceDef() { return 1/*_attrExtraEquip.piercedef*/; } //破击抗性
    inline float getExtraCounterDef() { return 1/*_attrExtraEquip.counterdef*/; } //反击抗性
    inline float getExtraAttackPierce() { return 1/*_attrExtraEquip.attackpierce*/; } //攻击穿透
