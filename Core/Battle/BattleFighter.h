...
public:
    ...
    inline float getExtraCriticalDef() { return _attrExtra.criticaldef; } //暴击抗性
    inline float getExtraPierceDef() { return _attrExtra.piercedef; } //破击抗性
    inline float getExtraCounterDef() { return _attrExtra.counterdef; } //反击抗性
    inline float getExtraAttackPierce() { return _attrExtra.attackpierce; } //攻击穿透
