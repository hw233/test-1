...
public:
    ...
    inline float getExtraCriticalDef() { return _attrExtraEquip.criticaldef; } //暴击抗性
    inline float getExtraPierceDef() { return _attrExtraEquip.piercedef; } //破击抗性
    inline float getExtraCounterDef() { return _attrExtraEquip.counterdef; } //反击抗性
    inline float getExtraAttackPierce() { return _attrExtraEquip.attackpierce; } //攻击穿透
