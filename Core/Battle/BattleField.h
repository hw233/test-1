    ...
    class BattleField
    {
        public:
            ...
            */
            ...
            BattleFighter * GetTarget(UInt8 side , UInt16 posX , UInt16 posY, BattleFighter* cur = NULL);
            BattleFighter * GetTargetForRide(UInt8 side , UInt16 posX , UInt16 posY,UInt8 direction = 2);
