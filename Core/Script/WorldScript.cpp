...
void WorldScript::init()
{
    ...
    def("setQzongPYGiftAct", GObject::World::setQzongPYGiftAct);
	...
	def("setSummerMeet", GObject::World::setSummerMeet);
    ...
    def("setGGTime",GObject::World::set11Time);
    def("getGGTime",GObject::World::get11Time);
