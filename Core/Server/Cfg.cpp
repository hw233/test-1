...
Cfg::Cfg( ): tcpPort(8888), serverIp(0), serverLogId(0), dbDataPort(3306), dbObjectPort(3306),
	...
	enableLoginLimit(false), loginLimit(10000), onlineLimit(0), udplog(true), dclog(true), secdclog(false),secdclogTest(false),unionPlatform(false),autoForbid(false),autoKick(false),
