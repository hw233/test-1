...
VAR_CLAN_LEAVE_TIME = 67, //退出帮派时间
        ...
        VAR_LUCKYMEET = 546,
        VAR_LUCKYMEET_AWARD = 547,
        VAR_LUCKYMEET_RECHARGE = 548,
        VAR_LUCKYMEET_RECHARGE_AWARD = 549 ,
        VAR_LUCKYMEET_VIP = 550 ,
        VAR_LUCKYMEET_STRENTH_AWARD = 551,

      
        VAR_SUMMER_MEET_TYPE = 552 ,
        VAR_SUMMER_MEET_TYPE_AWARD = 553,
        VAR_SUMMER_MEET_LOGIN = 554,
        VAR_SUMMER_MEET_LOGIN_AWARD = 555,
        ...
        //581-600 for lb 
        VAR_SUMMERFLOW3_TYPE = 564 ,
        VAR_SUMMERFLOW3_TYPE_AWARD = 565 ,
        VAR_SUMMERFLOW3_TIME = 566,
        VAR_SUMMERFLOW3_TIME_AWARD = 567,
...
#define REGISTER_VAR(Var, Type) \
    ...
    public:
        ...
        static void Init()
        {
            ...
            REGISTER_VAR(VAR_SUMMER_MEET_TYPE, CYCLE_NONE);
            REGISTER_VAR(VAR_SUMMER_MEET_TYPE_AWARD, CYCLE_NONE);
            REGISTER_VAR(VAR_SUMMER_MEET_LOGIN, CYCLE_NONE);
            REGISTER_VAR(VAR_SUMMER_MEET_LOGIN_AWARD, CYCLE_NONE);
            REGISTER_VAR(VAR_SUMMER_MEET_STRENTH_AWARD, CYCLE_DAY);
            ...
            REGISTER_VAR(VAR_SUMMERFLOW3_TIME, CYCLE_DAY);
