...
namespace GObject
{
    ...
    enum VarID
    {
        ...
        VAR_EXP_HOOK_INDEX = 404, //1:TRAINP1(初级),2:TRAINP2(高级，包括TRAINP4、ADVANCED_HOOK(超值)),3:TRAINP3
        VAR_EXP_HOOK_NEW_SOLUTION = 405, //加速符是否采用新方案(0:老方案, 1:新方案)
...
#define REGISTER_VAR(Var, Type) \
    ...
    public:
        ...
        static void Init()
        {
            ...
            REGISTER_VAR(VAR_EXP_HOOK_NEW_SOLUTION, CYCLE_NONE);
        }
