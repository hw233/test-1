...
namespace GObject
{
    ...
    enum VarID
    {
        ...
        VAR_WINTER_ENCOUNTER_RECHARGE_TOTAL = 860, //相约在冬季充值总数
        VAR_WINTER_ENCOUNTER_PLAN_STATUS = 861, //相约在冬季计划状态
...
#define REGISTER_VAR(Var, Type) \
    ...
    public:
        ...
        static void Init()
        {
            ...
            REGISTER_VAR(VAR_WINTER_ENCOUNTER_RECHARGE_TOTAL, CYCLE_NONE);
            REGISTER_VAR(VAR_WINTER_ENCOUNTER_PLAN_STATUS, CYCLE_NONE);
