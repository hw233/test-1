...
namespace GObject
{
    ...
    enum VarID
    {
        ...
        VAR_GRATITUDE_GIVING_AWARD_STATUS = 845, //三周年感恩大回馈领奖状态(0未领，1领取，从低逐位代表:银币，礼券，修为)
        VAR_GRATITUDE_GIVING_LEVEL = 846, //感恩大回馈结束时玩家等级
        VAR_GRATITUDE_GIVING_RECHARGE = 847, //感恩大回馈结束时玩家充值总数
        VAR_MAX,
    };
