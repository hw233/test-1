...
protected:
	...
	bool shiftTotalSaleList(UInt8, UInt16, UInt8&, UInt16&, UInt16&);
...
private:
	...
	SaleRowType _saleRow[47];	//普通1 强化2 (0 : reversed)
	...
	UInt32 _itemStat[47][7];	//分类(全部0 普通1 强化2 装备3.. 心法12.. 法宝15.. 阵法18.. 宝石31..) 0全部 1白色2绿色3蓝色4紫色5橙色6暗金
};
