...
namespace GObject
{
    ...
    enum FVarID
    {
        ...
        FVAR_WEAPON_LEVEL ,    //武器阶数 
        FVAR_ARMOR1_LEVEL ,    //胸甲阶数
        FVAR_ARMOR2_LEVEL ,    //护头阶数
        FVAR_ARMOR3_LEVEL ,    //绑腿阶数
        FVAR_ARMOR4_LEVEL ,    //戒指阶数
        FVAR_ARMOR5_LEVEL ,    //项链阶数
...
#define IDTYPE UInt64
    ...
    public:
        ...
        static void Init()
        {
            ...
            REGISTER_FVAR(FVAR_WEAPON_LEVEL, FCYCLE_NONE);
            REGISTER_FVAR(FVAR_ARMOR1_LEVEL, FCYCLE_NONE);
            REGISTER_FVAR(FVAR_ARMOR2_LEVEL, FCYCLE_NONE);
            REGISTER_FVAR(FVAR_ARMOR3_LEVEL, FCYCLE_NONE);
            REGISTER_FVAR(FVAR_ARMOR4_LEVEL, FCYCLE_NONE);
            REGISTER_FVAR(FVAR_ARMOR5_LEVEL, FCYCLE_NONE);
