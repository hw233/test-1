...
void Leaderboard::sendGoldLvlAward(BinaryReader& brd)
{
    ...
    */
    ...
    static MailPackage::MailItem s_items[][6][5] ={
        ...
        //2
        {
        { {9424, 5},   {503, 5},  {512, 5},   {0, 0} },
        { {517, 5},  {503, 5}, {9418, 5},  {512, 5},  {551, 5} },
        { {513, 8},  {134, 8},  {16001, 8},   {1126, 8} },
        { {9414, 15}, {1325, 15}, {0, 0},  {0, 0} },
        { {9457, 15}, {9498, 15}, {9600, 15}, {16001, 15} },
        { {9075, 20},  {0, 0}, {0, 0}, {0, 0} },
        },
        //3
        {
        ...
        { {9649, 10},  {1325, 8},  {547, 8},   {517, 8} },
        { {515, 10}, {9076, 10}, {0, 0},  {0, 0} },
        { {554, 20}, {16001, 20}, {9438, 20}, {0, 0} },
        { {9068, 20},  {0, 0}, {0, 0}, {0, 0} },
        },
        //4
        {
        { {549, 1},   {1126, 5},  {9424, 5},   {0, 0} },
        { {9310, 5},  {516, 5}, {500, 5},  {503, 5},  {513, 5} },
        { {515, 6},  {551, 6},  {9308, 6},   {9418, 6} },
        { {501, 30}, {9457, 30}, {16001, 30},  {0, 0} },
        { {9076, 20}, {0, 0}, {0, 0}, {0, 0} },
        { {1735, 1},  {0, 0}, {0, 0}, {0, 0} },
        },
        //5
