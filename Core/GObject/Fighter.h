...
public:
    ...
    inline std::vector<UInt16>& getPassiveSkillPrudent100() { return _passkl[GData::SKILL_PRUDENT-GData::SKILL_PASSSTART]; }
    inline std::vector<UInt16>& getPassiveSkillSilkworm100() { return _passkl[GData::SKILL_SILKWORM-GData::SKILL_PASSSTART]; }
    // 取得心法带出技能的ID表
