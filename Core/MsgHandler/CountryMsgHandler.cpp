...
MSG_REG(GameMsgHdr, OnComparBattelPoint);
...
MSG_REG_2(GameMsgHdr, REQ::MO_BAO, OnMoBaoReq);
...
MSG_REG_2(GameMsgHdr, REQ::ZHENYUAN_REQ, OnZhenyuanReq);
...
MSG_REG_2(GameMsgHdr, 0x275, OnCompareBP);
